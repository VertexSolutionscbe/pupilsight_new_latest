...
<head>
    ...
    <link rel='stylesheet' id='rs-plugin-settings-css' href='cms/assets/revslider/public/assets/css/rs6.css' type='text/css' media='all' />


    <link rel='stylesheet' id='learn-press-pmpro-style-css' href='cms/assets/plugins/learnpress-paid-membership-pro/assets/style.css' type='text/css' media='all' />

    <link rel='stylesheet' id='builder-press-slick-css' href='cms/assets/plugins/builderpress/assets/libs/slick/slick.css' type='text/css' media='all' />

    <link rel='stylesheet' id='js_composer_front-css' href='cms/assets/plugins/js_composer/assets/css/js_composer.min.css' type='text/css' media='all' />

    <link rel='stylesheet' id='dashicons-css' href='cms/assets/css/dashicons.min.css' type='text/css' media='all' />
    <link rel='stylesheet' id='learn-press-bundle-css' href='cms/assets/plugins/learnpress/assets/css/bundle.min.css' type='text/css' media='all' />
    <link rel='stylesheet' id='learn-press-css' href='cms/assets/plugins/learnpress/assets/css/learnpress.css' type='text/css' media='all' />
    <link rel='stylesheet' id='ionicon-css' href='cms/assets/css/ionicons/ionicons.css' type='text/css' media='all' />
    <link rel='stylesheet' id='select2-style-css' href='cms/assets/css/select2/core.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builder-press-bootstrap-css' href='cms/assets/css/bootstrap/bootstrap.css' type='text/css' media='all' />


    <link rel='stylesheet' id='thim-style-css' href='cms/assets/css/style.css' type='text/css' media='all' />


    <link rel='stylesheet' id='thim-style-options-css' href='cms/assets/css/demo.css' type='text/css' media='all' />
    <script type='text/javascript' src='cms/assets/js/jquery/jquery.js'></script>
    <script type='text/javascript' src='cms/assets/js/jquery/jquery-migrate.min.js'></script>
    ...
    <script type="text/javascript" src="assets/js/core.min.js?v=18.0.01"></script>
    <style>
	...
	var number = $("#txtPhone").val();
	 var filter = /[1-9]{1}[0-9]{9}/;
        ...
        <?php if (!empty($_GET['return'])) { ?>
            alert('Your Application Submitted Successfully, Please Check Your Status from Application Status!');
        <?php } ?>
    ...
    <script type='text/javascript' src='cms/assets/plugins/learnpress-wishlist/assets/js/wishlist.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/miniorange-login-openid/includes/js/jquery.cookie.min.js'>
    </script>
    <script type='text/javascript' src='cms/assets/plugins/miniorange-login-openid/includes/js/social_login.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/assets/libs/slick/slick.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/assets/js/builderpress.js'></script>
    <script type='text/javascript' src='cms/assets/revslider/public/assets/js/revolution.tools.min.js'></script>
    <script type='text/javascript' src='cms/assets/revslider/public/assets/js/rs6.min.js'></script>
    <script type='text/javascript' src='cms/assets/js/underscore.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/learnpress-coming-soon-courses/assets/js/jquery.mb-coming-soon.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/learnpress-coming-soon-courses/assets/js/coming-soon-course.js'>
    </script>
    <script type='text/javascript' src='cms/assets/plugins/learnpress/assets/js/vendor/plugins.all.min.js'></script>


    <link rel="icon" href="cms/assets/uploads/sites/5/2018/10/favicon.png" sizes="32x32" />
    <link rel="icon" href="cms/assets/uploads/sites/5/2018/10/favicon.png" sizes="192x192" />
    <link rel="apple-touch-icon-precomposed" href="cms/icon/favicon.png" />
    <meta name="msapplication-TileImage" content="cms/icon/favicon.png" />
                ...
                <div class="header-wrapper">
                    <div class="width-logo sm-logo">
                        <?php if ($data['logo_image'] != '') { ?>
                            ...
                            <img class="mobile-logo" src="<?php echo 'cms/images/logo/' . $data['logo_image']; ?>" alt="" />
                            <img src="<?php echo 'cms/images/logo/' . $data['logo_image']; ?>" alt="" width="160" height="50" />
                        <?php } ?>
                        <!-- <img src="<?php echo 'cms/images/logo/' . $data['logo_image']; ?>" alt="" width="221" height="64" /> -->
                    </div>
                    <nav class="width-navigation main-navigation">
                        <ul id="primaryMenu">
                            ...
                            <li id="menu-item-1069" class="menu-item menu-item-type-post_type_archive menu-item-object-tp_event menu-item-1069 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                                <a href="#events" class="tc-menu-inner">Events</a>
                            </li>
                            <li id="menu-item-1069" class="menu-item menu-item-type-post_type_archive menu-item-object-tp_event menu-item-1069 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                                <a href="#announcement" class="tc-menu-inner">Announcement</a>
                            </li>
                            ...
                            <li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                                <a href="#contactus" class="tc-menu-inner">Contact us</a>
                            </li>
                            ...
                            <li id="menu-item-606" class=" dropdown menu-item show_list menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                                <a href="#" class="tc-menu-inner">Admissions</a>
                                                ...
                                                <div id="bp-popup-login" class="white-popup mfp-with-anim mfp-hide has-shortcode">
                                                    <div class="loginwrapper">
                                                        ...
                                                        <div class="login-popup box-register">
                                                            <div class="media-content" style="background-image: url(cms/assets/uploads/sites/5/2018/10/event-02.jpg)">
                                                            </div>
                                                            <div class="inner-login">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="shortcode">
                                                                        ...
                                                                        <script src="cms/assets/plugins/miniorange-login-openid/includes/js/jquery.cookie.min.js">
                                                                        </script>
                                                                        <script type="text/javascript">
                                                                        ...
                                                                        <!--div class='mo-openid-app-icons'>
                                                                            ...
                                                                            <a class=' login-button' rel='nofollow'
                                                                                ...
                                                                                title=' Login with Google'><img
                                                                                    ...
                                                                                    src='cms/assets/plugins/miniorange-login-openid/includes/images/icons/google.png'
                                                                                ...
                                                                                onClick="moOpenIdLogin('twitter','false');"><img
                                                                                    alt='Twitter'
                                                                                    style=' width:35px !important;height: 35px !important;margin-left: 10px !important'
                                                                                    src='cms/assets/plugins/miniorange-login-openid/includes/images/icons/twitter.png'
                                                                                    class=' login-button roundededges'></a><a
                                                                                class=' login-button' rel='nofollow'
                                                                                ...
                                                                                onClick="moOpenIdLogin('linkedin','false');"><img
                                                                                    alt='LinkedIn'
                                                                                    style='width:35px !important;height: 35px !important;margin-left: 10px !important'
                                                                                    src='cms/assets/plugins/miniorange-login-openid/includes/images/icons/linkedin.png'
                                                                                    class=' login-button roundededges'></a><a
                                                                                class=' login-button' rel='nofollow'
                                                                                ...
                                                                                onClick="moOpenIdLogin('instagram','false');"><img
                                                                                    alt='Instagram'
                                                                                    style='width:35px !important;height: 35px !important;margin-left: 10px !important'
                                                                                    src='cms/assets/plugins/miniorange-login-openid/includes/images/icons/instagram.png'
                                                                                    class=' login-button roundededges'></a>
                                                                        </div!--> <br>
                                                                        <div style='float:left;' class='mo_image_id'>
                                                                            <a target='_blank' href='https://www.miniorange.com/'>
                                                                                <img alt='logo' src='cms/assets/plugins/miniorange-login-openid/includes/images/miniOrange.png' class='mo_openid_image'>
                                                                            </a>
                                                                        </div>
                                                                        <br />
                                                                    </div>
                                                                        ...
                                                                        <form action="../login.php?" method="post" autocomplete="off" enctype="multipart/form-data" id="loginForm" onsubmit="pupilsightFormSubmitted(this)">
                                                                            <p class="login-username">
                                                                                <label for="bp_login_name">Username or
                                                                                    Email Address</label>
                                                                                <input type="text" name="username" id="username" class="input" value="<?php if (isset($_COOKIE["username"])) {
                                                                                                                                                            echo $_COOKIE["username"];
                                                                                                                                                        } ?>" size="20" />
                                                                            </p>
                                                                            <p class="login-password">
                                                                                <label for="bp_login_pass">Password</label>
                                                                                <input type="password" name="password" id="password" class="input" value="<?php if (isset($_COOKIE["password"])) {
            ...
            <ul class="nav navbar-nav">
                ...
                <li id="menu-item-606" class=" dropdown menu-item show_list menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                    ...
                    <ul class="dropdown-content" style="position:inherit;">
                        <?php if (!empty($campaign)) { ?>
                            <li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default" style="padding:5px 10px !important;"><a href="#application" class="tc-menu-inner" data-toggle="modal" data-target="#Application">Application</a>
                            </li>
                        <?php } ?>
                        <li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default" style="padding:5px 10px !important;"><a href="#app_status" class="tc-menu-inner" data-toggle="modal" data-target="#app_status">Application Status</a>
                        </li>
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
                    <a href="#" class="tc-menu-inner" onclick="loginMobile();">Login</a>
                </li>
            </ul>
        ...
        <div id="main-content">
            <script>
                ...
                $(document).ready(function() {
                    console.log("ready!");
                    setTimeout(loadHeader(), 1000);
                });

                function loadHeader() {
                    alert("update");
                    $("#sliderTitle").html("<?= trim(html_entity_decode($data['cms_banner_title'])); ?>");
                    $("#shortDescription").html("<?= trim(html_entity_decode($data['cms_banner_short_description'])); ?>");
                }*/
            </script>
                        ...
                        <div class="vc_column-inner">
                                        ...
                                        <rs-module id="rev_slider_2_1" style="display:none;" data-version="6.1.0">
                                            <rs-slides>
                                                <rs-slide data-key="rs-2" data-title="Slide" data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:d;">
                                                    <img src="cms/assets/revslider/public/assets/assets/transparent.png" title="Home" data-bg="c:linear-gradient(90deg, rgba(78,88,178,1) 0%, rgba(80,98,217,1) 100%);" class="rev-slidebg" data-no-retina>
                                                    <!--
							-->
							...
							-->
                                                    ...
                                                    <rs-layer id="slider-2-slide-2-layer-1" data-type="text" data-rsp_ch="on" data-xy="x:l,l,c,c;y:m;yo:-175px,-160px,-130px,-130px;" data-text="s:65,50,65,55;l:75,60,75,65;ls:0px,0,0,0;fw:300;a:inherit,inherit,center,center;" data-dim="h:160px,auto,160px,140px;" data-frame_0="y:100%;tp:600;" data-frame_0_mask="u:t;y:100%;" data-frame_1="tp:600;st:900;sp:1500;sR:900;" data-frame_1_mask="u:t;" data-frame_999="st:w;sp:1000;auto:true;" data-frame_999_mask="u:t;">
                                                        <span id="sliderTitle" style='font-size:36px;'>
                                                            <?= trim(html_entity_decode($data['cms_banner_title'])); ?>
                                                        </span>
                                                    </rs-layer>
							...
							-->
                                                    <rs-layer id="slider-2-slide-2-layer-2" data-type="image" data-rsp_ch="on" data-xy="x:r;xo:-75px;y:m;yo:-50px,-30px,0,0;" data-text="l:22;a:inherit;" data-dim="w:791px,598px,791px,791px;h:555px,420px,555px,555px;" data-vbility="t,t,f,f" data-frame_0="y:100%;tp:600;" data-frame_0_mask="u:t;y:100%;" data-frame_1="tp:600;e:Power2.easeInOut;st:500;sp:1500;sR:500;" data-frame_1_mask="u:t;" data-frame_999="st:w;sp:1000;auto:true;" data-frame_999_mask="u:t;" style="z-index:8;">
                                                        ...
                                                        <?php if ($data['cms_banner_image'] != '') { ?>
                                                            <img src="<?php echo 'cms/images/banner/' . $data['cms_banner_image']; ?>" width="791" height="555" data-no-retina>
                                                        <?php } ?>
                                                    </rs-layer>
                                                    <!--
							-->
							...
							-->
                                                    <rs-layer id="slider-2-slide-2-layer-10" data-type="image" data-rsp_ch="on" data-xy="x:r;xo:-250px,-250px,-250px,0;y:b;yo:118px,118px,118px,-60px;" data-text="l:22;a:inherit;" data-dim="w:['156px','156px','156px','156px'];h:['153px','153px','153px','153px'];" data-frame_0="y:bottom;sX:2;sY:2;o:1;rZ:90deg;tp:600;" data-frame_1="tp:600;st:650;sp:2000;sR:650;" data-frame_999="st:w;sp:1000;auto:true;" style="z-index:13;">
                                                        <img src="cms/assets/uploads/sites/5/2018/12/cycle-3-03.png" width="156" height="153" data-no-retina>
                                                    </rs-layer>
                                                    <!--
-->
                                                </rs-slide>
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_right">
                                        <figure class="wpb_wrapper vc_figure">
                                            <?php if (!empty($section['6']['0']['image_path'])) { ?>
                                                <div class="vc_single_image-wrapper   vc_box_border_grey "><img width="685" height="670" src="<?php echo 'cms/images/upload/' . $section['6']['0']['image']; ?>" class="vc_single_image-img attachment-full" alt="" srcset="" sizes="(max-width: 685px) 100vw, 685px" /></div>
                                            <?php } else { ?>
                                                <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="685" height="670" src="cms/assets/uploads/sites/5/2018/10/bg-18.jpg" class="vc_single_image-img attachment-full" alt="" srcset="cms/assets/uploads/sites/5/2018/10/bg-18.jpg 685w, cms/assets/uploads/sites/5/2018/10/bg-18-300x293.jpg 300w, cms/assets/uploads/sites/5/2018/10/bg-18-600x587.jpg 600w" sizes="(max-width: 685px) 100vw, 685px" /></div>
                                            <?php } ?>
                                                ...
                                                ?>
                                                        <div class="item-slick">
                                                            <div class="course-item <?php echo $cls; ?>">
                                                                <a href="" class="content" style="background-image: url(<?php echo 'cms/images/upload/' . $sec['image']; ?>);">
                                                                    <h3 class="title">
                                            ...
                                            ?>
                                                        ...
                                                        <div class="item-course <?php echo $cls; ?>">
                                                            <?php if (!empty($crs['image'])) { ?>
                                                                <div class="pic" style='height:175px;'>
                                                                    <a href="index.html">
                                                                        <img src="<?php echo 'cms/images/upload/' . $crs['image']; ?>" alt="Untitled-19" class="">
                                                                    </a>
                                                            ...
                                                            <div class="text">
                                                                <div class="teacher">
                                                                    <?php if (!empty($crs['person_image'])) { ?>
                                                                        <div class="ava">
                                                                            <img alt="Admin bar avatar" src="<?php echo 'cms/images/upload/' . $crs['person_image']; ?>" class="avatar avatar-68 photo" height="68" width="68" />
                                                                        </div>
                                                                    <?php } ?>
                                                ...
                                                <div class="custom-col col-sm-6 col-md-6 col-lg-3 wrapper-item-course">
                                                    <div class="item-course color-2">
                                                        <div class="pic">
                                                            <a href="index.html">
                                                                <img src="cms/assets/uploads/sites/5/2017/12/Untitled-19-450x300.jpg" alt="Untitled-19" class="">
                                                            </a>
                                                            <div class="price">
                                                        ...
                                                        <div class="text">
                                                            <div class="teacher">
                                                                <div class="ava">
                                                                    <img alt="Admin bar avatar" src="cms/assets/uploads/learn-press-profile/5/2448c53ace919662a2b977d2be3a47c5.jpg" class="avatar avatar-68 photo" height="68" width="68" />
                                                                </div>
            ...
            <span class="inner-text">VIEW ALL COURSES</span>
                ...
                Read More                <i class="ion ion-ios-arrow-thin-right"></i>
                                                            ...
                                                            <?php if (!empty($exp['image_path'])) { ?>
                                                                <img src="<?php echo 'cms/images/upload/' . $exp['image']; ?>" alt="Untitled-2A" class="">
                                                            <?php } else { ?>
                                                                <img src="cms/assets/uploads/sites/5/2018/10/Untitled-2-426x426.jpg" alt="Untitled-2" class="">
                                                            <?php } ?>
                                                ...
                                                ?>
                                                        <div class="item-slick">
                                                            <div class="event-item <?php echo $cls; ?>">
                                                                <div class="pic">
                                                                    <img src="<?php echo 'cms/images/upload/' . $nws['image']; ?>" alt="Untitled-13" class="">
                                                                </div>
                                                                <?php if (!empty($nws['date'])) { ?>
                                                                    <div class="date">
                                                                        <span><?php echo $nws['date']; ?></span>
                                                                    </div>
                                                                <?php } ?>
                                                                <div class="text">
                                                                    <div class="time">
                                                                    ...
                                                                    <?php if (!empty($nws['person_name'])) { ?>
                                                                        <div class="author">
                                                                            <div class="ava">
                                                                                <img src="<?php echo 'cms/images/upload/' . $nws['person_image']; ?>" alt="IMG">
                                                                            </div>
                                                                            <div class="info">
                                                                                <div class="name">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="img-testimonial">
                                                    <img src="<?php echo 'cms/images/upload/' . $data['comment_image']; ?>" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                                ...
                                                                <div class="testimonial-item">
                                                                    ...
                                                                    <div class="author">
                                                                        <?php if (!empty($cmm['person_image'])) { ?>
                                                                            <div class="ava">
                                                                                <img src="<?php echo 'cms/images/upload/' . $cmm['person_image']; ?>" alt="gallery-07" class="">
                                                                            </div>
                                                                        <?php } ?>
                                                                        <div class="info">
                                ...
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="center">
                                        <?php if ($data['phone'] != '') { ?>
                                            ...
                                            <div>
                                                <h6>Contact Number:</h6><?php echo $data['phone']; ?>
                                            </div>
...
<div class="js-call-slick-col" data-pagination="" data-numofslide="5" data-numofscroll="1"
    ...
    <div class="slide-slick">
                ...
                <div class="item-brands">
					<img src="cms/assets/uploads/sites/5/2018/10/logo-07.png" width="127" height="42" alt="Logo">                </div>
            </div>
		            <div class="item-slick">
                <div class="item-brands">
					<img src="cms/assets/uploads/sites/5/2018/10/logo-07.png" width="127" height="42" alt="Logo">                </div>
                                            ...
                                            <div class="wpb_single_image wpb_content_element vc_align_left   max-width-163">
                                                <figure class="wpb_wrapper vc_figure">
                                                    <div class="vc_single_image-wrapper   vc_box_border_grey">
                                                        <?php if ($data['logo_image'] != '') { ?>
                                                            <img width="160" height="50" src="<?php echo 'cms/images/logo/' . $data['logo_image']; ?>" class="vc_single_image-img attachment-full" alt="" srcset="" sizes="(max-width: 336px) 100vw, 336px" />
                                                        <?php } ?>
                                                    </div>
                                                </figure>
                                            </div>
...
<li id="menu-item-1233" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1233 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="index.html" class="tc-menu-inner">Programs</a></li>
            ...
            <div class="container">
                <div class="copyright-content">
                    <div class="copyright-text">
                        <a target="_blank" href="https://www.parentof.com/">Powered by ParentOf </a>
                    </div>
 ...
 -->
    ...
    <link rel='stylesheet' id='builder-press-magnific-popup-css' href='cms/assets/plugins/builderpress/assets/libs/magnific-popup/magnific-popup.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-login-popup-css' href='cms/assets/plugins/builderpress/inc/elements/general/login-popup/assets/css/login-popup.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-button-css' href='cms/assets/plugins/builderpress/inc/elements/general/button/assets/css/button.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-search-posts-css' href='cms/assets/plugins/builderpress/inc/elements/general/search-posts/assets/css/search-posts.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-image-box-css' href='cms/assets/plugins/builderpress/inc/elements/general/image-box/assets/css/image-box.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-heading-css' href='cms/assets/plugins/builderpress/inc/elements/general/heading/assets/css/heading.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-course-collections-css' href='cms/assets/plugins/builderpress/inc/elements/learnpress-collections/course-collections/assets/css/course-collections.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-counter-box-css' href='cms/assets/plugins/builderpress/inc/elements/general/counter-box/assets/css/counter-box.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-list-courses-css' href='cms/assets/plugins/builderpress/inc/elements/learnpress/list-courses/assets/css/list-courses.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-list-events-css' href='cms/assets/plugins/builderpress/inc/elements/wp-events-manager/list-events/assets/css/list-events.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-testimonials-css' href='cms/assets/plugins/builderpress/inc/elements/general/testimonials/assets/css/testimonials.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-call-to-action-css' href='cms/assets/plugins/builderpress/inc/elements/general/call-to-action/assets/css/call-to-action.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builder-press-owl-carousel-css' href='cms/assets/plugins/builderpress/assets/libs/owl-carousel/owl.carousel.min.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-brands-css' href='cms/assets/plugins/builderpress/inc/elements/general/brands/assets/css/brands.css' type='text/css' media='all' />
    <link rel='stylesheet' id='builderpress-element-social-links-css' href='cms/assets/plugins/builderpress/inc/elements/general/social-links/assets/css/social-links.css' type='text/css' media='all' />
    <script type='text/javascript' src='cms/assets/js/jquery/ui/core.min.js'></script>

    <script type='text/javascript' src='cms/assets/js/wp-util.min.js'></script>
    <script type='text/javascript' src='cms/assets/js/backbone.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/wp-events-manager/inc/libraries/countdown/js/jquery.plugin.min.js'></script>

    <script type='text/javascript' src='cms/assets/plugins/wp-events-manager/inc/libraries/countdown/js/jquery.countdown.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/wp-events-manager/inc/libraries/owl-carousel/js/owl.carousel.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/wp-events-manager/inc/libraries/magnific-popup/js/jquery.magnific-popup.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/wp-events-manager/assets/js/frontend/events.js'></script>

    <script type='text/javascript' src='cms/assets/themes/ivy-school/assets/js/libs/1_tether.min.js'></script>
    <script type='text/javascript' src='cms/assets/themes/ivy-school/assets/js/libs/bootstrap.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/js_composer/assets/lib/bower/flexslider/jquery.flexslider-min.js'></script>
    <script type='text/javascript' src='cms/assets/themes/ivy-school/assets/js/libs/stellar.min.js'></script>
    <script type='text/javascript' src='cms/assets/themes/ivy-school/assets/js/libs/theia-sticky-sidebar.js'></script>
    <script type='text/javascript' src='cms/assets/js/imagesloaded.min.js'></script>
    <script type='text/javascript' src='cms/assets/themes/ivy-school/assets/js/thim-custom.js'></script>
    <script type='text/javascript' src='cms/assets/js/wp-embed.min.js'></script>
    <script type='text/javascript' src='cms/ajax/libs/webfont/1-6-26/webfont.js'></script>
    <script type='text/javascript'>
        WebFont.load({
            google: {
    ...
    <script type='text/javascript' src='cms/assets/plugins/js_composer/assets/js/dist/js_composer_front.min.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/assets/libs/magnific-popup/jquery.magnific-popup.min.js'></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
        var login_popup_js = {
            "login": "Email",
    ...
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/login-popup/assets/js/login-popup.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/search-posts/assets/js/search-posts.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/image-box/assets/js/image-box.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/assets/libs/waypoints/jquery.waypoints.min.js'>
    </script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/counter-box/assets/js/counter-box.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/testimonials/assets/js/testimonials.js'></script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/assets/libs/owl-carousel/owl.carousel.min.js'>
    </script>
    <script type='text/javascript' src='cms/assets/plugins/builderpress/inc/elements/general/brands/assets/js/brands.js'>
    </script>
                    ...
                    <div class="modal-body">
                        <table cellspacing='0' class='table table-responsive-sm' style='width: 100%; font-size: 16px;'>
                            ...
                            <?php foreach ($campaign as $row) {
                                ...
                                echo '<td>';
                                if ($row['page_for'] == '1') {
                                    echo ' <a href="cms/application_page.php?url_id=' . $row['id'] . '&status=not"   class="btnShow btn btn-info btn-lg" type="button" id="btnShow"  style="font-size: 14px;" >Apply Now</a>';
                                } else {
                                    echo ' <a href="cms/register.php?url_id=' . $row['id'] . '"   class="btnShow btn btn-info btn-lg" type="button" id="btnShow"  style="font-size: 14px;" >Register & Apply</a>';
                                }
                                echo '</td>';
                                echo '</tr>';
