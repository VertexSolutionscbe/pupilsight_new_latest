...
-->
<div style='width:100%;height:100vh;position:absolute;z-index:1000;top:0px;left:0px;background-color:#f2f2f2;'>Loading..</div>
<div style=''>
<?php
$loginuser = urldecode($_GET["user"]);
$loginpass = urldecode($_GET["pass"]);
...
if (isloggedin() and !isguestuser()) {
    header("Location: http://moodle.pupiltalk.com/my/");
}
...
<script>
    function autoLogin(){
        ...
        document.getElementById("password").value = "<?=$loginpass; ?>";
