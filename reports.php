...
$page->addData([
    ...
    'iframesrc' => "http://wp.pupiltalk.com/wp-login.php?user=".urlencode($_SESSION['loginuser'])."&pass=".urlencode($_SESSION['loginpass'])
]);
...
echo $page->render('index_frame.twig.html');