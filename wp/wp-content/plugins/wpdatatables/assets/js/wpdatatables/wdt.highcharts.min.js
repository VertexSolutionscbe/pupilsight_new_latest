var wpDataTablesHighchart=function(){var obj={container:'#wdtHighChartContainer',columnIndexes:[],numberFormat:1,connectedWPDataTable:null,renderCallback:null,chart:null,setContainer:function(container){this.container=container;this.options.chart.renderTo=container.replace('#','')},getContainer:function(){return this.container},setWidth:function(width){if(isNaN(width)||width==null||width==0){delete this.options.chart.width}else{this.options.chart.width=parseInt(width)}},getWidth:function(){return this.options.chart.width},setHeight:function(height){this.options.chart.height=parseInt(height)},getHeight:function(){return this.options.chart.height},setRenderCallback:function(callback){this.renderCallback=callback},options:{chart:{backgroundColor:'#FFFFFF',borderColor:'#4572A7',borderRadius:0,borderWidth:0,height:400,inverted:!1,panning:!1,panKey:'shift',plotBackgroundColor:'undefined',plotBackgroundImage:'undefined',plotBorderColor:'undefined',plotBorderWidth:0,type:'line',zoomType:'undefined'},credits:{enabled:!0,href:'http://www.highcharts.com',text:'Highcharts.com'},exporting:{buttons:{contextButton:{align:'right',symbolStroke:'#666',text:null,verticalAlign:'top'}},enabled:!0,chartOptions:{plotOptions:{series:{dataLabels:{enabled:!1}}}},filename:'Chart',width:'undefined'},legend:{backgroundColor:'#FFFFFF',title:{'text':''},layout:'horizontal',align:'right',verticalAlign:'bottom',borderWidth:0,borderColor:'#909090'},plotOptions:{},series:[],subtitle:{align:'center',floating:!1,text:'undefined'},title:{align:'center',floating:!1,text:''},tooltip:{backgroundColor:'rgba(255, 255, 255, 0.85)',borderColor:null,borderRadius:3,borderWidth:1,enabled:!0,shared:!1,valuePrefix:'undefined',valueSuffix:'undefined'},xAxis:{crosshair:!1},yAxis:{crosshair:!1,gridLineDashStyle:'Solid',title:{align:'align',text:''},plotLines:[{"value":0,"width":1,"color":"#808080"}]}},setOptions:function(options){for(var property in options){this.options[property]=options[property]}},setNumberFormat:function(numberFormat){this.numberFormat=numberFormat},getNumberFormat:function(){return this.numberFormat},getOptions:function(){return this.options},render:function(){if(this.renderCallback!==null){this.renderCallback(this)}
this.chart=new Highcharts.Chart(this.options);Highcharts.setOptions({lang:{decimalPoint:this.getNumberFormat()==='1'?',':'.',thousandsSep:this.getNumberFormat()==='1'?'.':','}})},setType:function(type){switch(type){case 'highcharts_basic_area_chart':this.options.chart.type='area';break;case 'highcharts_stacked_area_chart':this.options.chart.type='area';this.options.plotOptions={area:{stacking:'normal'}};break;case 'highcharts_basic_bar_chart':this.options.chart.type='bar';break;case 'highcharts_scatter_plot':this.options.chart.type='scatter';break;case 'highcharts_stacked_bar_chart':this.options.chart.type='bar';this.options.plotOptions={series:{stacking:'normal'}};break;case 'highcharts_basic_column_chart':this.options.chart.type='column';break;case 'highcharts_3d_column_chart':this.options.chart.type='column';this.options.chart.margin=75;this.options.chart.options3d={enabled:!0,alpha:15,beta:15,viewDistance:25,depth:40};this.options.plotOptions={column:{depth:25}};break;case 'highcharts_stacked_column_chart':this.options.chart.type='column';this.options.plotOptions={column:{stacking:'normal'}};break;case 'highcharts_pie_chart':this.options.chart.type='pie';this.options.plotOptions={pie:{allowPointSelect:!0,cursor:'pointer',dataLabels:{enabled:!0,format:'<b>{point.name}</b>: {point.percentage:.1f} %',style:{color:(Highcharts.theme&&Highcharts.theme.contrastTextColor)||'black'}}}};this.options.tooltip.pointFormat='{series.name}: <b>{point.percentage:.1f}%</b>'
