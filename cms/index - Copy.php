...
.modal-backdrop 
{
	...
	<script type='text/javascript' src='assets/plugins/miniorange-login-openid/includes/js/jquery.cookie.min.js'></script>
	...
	<script type='text/javascript' src='assets/plugins/learnpress-coming-soon-courses/assets/js/coming-soon-course.js'></script>
			...
			<div class="container">
				<div class="header-wrapper">
					...
					<nav class="width-navigation main-navigation">
						<ul id="primaryMenu">
							<li id="menu-item-646" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-17 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor  menu-item-646 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="" class="tc-menu-inner">Home</a>
							</li>

							<li id="menu-item-634" class="menu-item menu-item-type-custom menu-item-object-custom  menu-item-634 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#aboutus" class="tc-menu-inner">About</a>
							</li>
							<li id="menu-item-642" class="menu-item menu-item-type-post_type_archive menu-item-object-lp_course  menu-item-642 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#courses" class="tc-menu-inner">Courses</a>
							</li>
							<li id="menu-item-1069" class="menu-item menu-item-type-post_type_archive menu-item-object-tp_event menu-item-1069 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#events" class="tc-menu-inner">Events</a></li>
							<li id="menu-item-1069" class="menu-item menu-item-type-post_type_archive menu-item-object-tp_event menu-item-1069 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#announcement" class="tc-menu-inner">Announcement</a></li>

							<li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#contactus" class="tc-menu-inner">Contact us</a></li>
							
							<li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a id="application" href="#application" 

class=" tc-menu-inner" data-toggle="modal" data-target="#myModal">Application</a>
							<!--ul class="dropdown-menu dropdown-content">
									<li id="menu-item-606" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#application_view" class="tc-menu-inner">Apply Now</a>
									</li>
								<ul!-->
							</li>
										...
										<div class="wpb_wrapper">
											<div class="bp-element bp-element-login-popup    layout-1 ">
												<div class="login-links">
													<a class="login" data-active=".box-login" data-effect="mfp-zoom-in" title="Login" href="#bp-popup-login">Login</a>
												</div>
												<div id="bp-popup-login" class="white-popup mfp-with-anim mfp-hide has-shortcode">
													<div class="loginwrapper">
															...
															<div class="inner-login">
																...
																<div class="form-row">
																	...
																	<div class="shortcode">
																		...
																		<script src="assets/plugins/miniorange-login-openid/includes/js/jquery.cookie.min.js"></script>
																		<script type="text/javascript">
																		...
																		<div class='mo-openid-app-icons'>
																			<p style='color:#000000'> Connect with:</p><a class=' login-button' rel='nofollow' onClick="moOpenIdLogin('google','false');" title=' Login with Google'><img alt='Google' style='width:35px !important;height: 35px !important;margin-left: 10px !important' src='assets/plugins/miniorange-login-openid/includes/images/icons/google.png' class=' login-button roundededges'></a><a class=' login-button' rel='nofollow' title=' Login with Twitter' onClick="moOpenIdLogin('twitter','false');"><img alt='Twitter' style=' width:35px !important;height: 35px !important;margin-left: 10px !important' src='assets/plugins/miniorange-login-openid/includes/images/icons/twitter.png' class=' login-button roundededges'></a><a class=' login-button' rel='nofollow' title=' Login with LinkedIn' onClick="moOpenIdLogin('linkedin','false');"><img alt='LinkedIn' style='width:35px !important;height: 35px !important;margin-left: 10px !important' src='assets/plugins/miniorange-login-openid/includes/images/icons/linkedin.png' class=' login-button roundededges'></a><a class=' login-button' rel='nofollow' Login with Instagram' onClick="moOpenIdLogin('instagram','false');"><img alt='Instagram' style='width:35px !important;height: 35px !important;margin-left: 10px !important' src='assets/plugins/miniorange-login-openid/includes/images/icons/instagram.png' class=' login-button roundededges'></a>
																		</div> <br>
														...
														<div class="login-popup box-login">
															<div class="media-content" style="background-image: url(assets/uploads/sites/5/2018/10/event-02.jpg)"></div>
															<div class="inner-login">
																<h3 class="title">
																	<span><a href="#register" class="display-box" data-display=".box-register">Register</a></span>
																...
																<div class="form-row">
																	<div class="wrap-form">
																		...
																		<form action="../login.php?" method="post" autocomplete="off" enctype="multipart/form-data" id="loginForm" onsubmit="pupilsightFormSubmitted(this)">
																			...
																			<select id="pupilsightSchoolYearID" name="pupilsightSchoolYearID" class="d-none fullWidth"><option value="023">2017-18</option><option value="024">2018-19</option><option value="025" selected="">2019-20</option><option value="026">2020-21</option></select>
																		</form>
																	...
																	<div class="shortcode">
																		...
																		<script type="text/javascript">
																			...
																			function moOpenIdLogin(app_name, is_custom_app) {
																				...
																				var expires = "expires=" + d.toUTCString();
																				document.cookie = cookie_name + "=" + current_url + ";" + expires + ";path=/";
																				var base_url = 'http://ivy-school.thimpress.com/demo-3';
																				var request_uri = '/demo-3/';
																				var http = 'http://';
																				var http_host = 'ivy-school.thimpress.com';
																				var default_nonce = 'a983c9d137';
															...
															<div class="inner-login">
																...
																<div class="form-row">
																	<form name="lostpasswordform" id="lostpasswordform" action="index.html" method="post">
																		...
																		<p class="link-bottom">Are you a member? <a href="#login" class="display-box" data-display=".box-login">Sign in now</a>
																		</p>
																	</form>
																</div>
															</div>
		...
		<nav class="visible-xs mobile-menu-container mobile-effect" itemscope itemtype="http://schema.org/SiteNavigationElement">
			<ul class="nav navbar-nav">
				...
				<li class="menu-item menu-item-type-custom menu-item-object-custom  menu-item-634 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#aboutus" class="tc-menu-inner">About</a>
				</li>
				<li class="menu-item menu-item-type-post_type_archive menu-item-object-lp_course  menu-item-642 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#courses" class="tc-menu-inner">Courses</a>
				</li>
				<li class="menu-item menu-item-type-post_type_archive menu-item-object-tp_event menu-item-1069 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#events" class="tc-menu-inner">Events</a></li>
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-605 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#announcement" class="tc-menu-inner">Announcement</a></li>
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-606 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#contactus" class="tc-menu-inner">Contact us</a></li>
...
-->
							...
							<div class="vc_column-inner vc_custom_1540537006055">
								<div class="wpb_wrapper">
									<div class="bp-element bp-element-heading vc_custom_1542033515902 align-right layout-1  mobile-center mobile-line-heading">
										...
										<div class="line" style="height:2px; width:87px; background-color:#e1e1e1; margin:0 -20px 0 0; "></div>
									</div>
				...
				<?php if ($data['announcement_status'] == '1') { ?>
					<div data-class-mobile="vc_custom_1542980392927" data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1542980392924 bp-background-size-auto vc_row-has-fill">
						<div class="wpb_column vc_column_container vc_col-sm-12 bp-background-size-auto">
							<div class="vc_column-inner">
								<div class="wpb_wrapper">
															...
															<div class="text">
																<div class="teacher">
																	<?php if (!empty($crs['person_image'])) { ?>
																		<div class="ava">
																			<img alt="Admin bar avatar" src="<?php echo 'images/upload/' . $crs['person_image']; ?>" class="avatar avatar-68 photo" height="68" width="68" /> </div>
																	<?php } ?>
												...
												<div class="custom-col col-sm-6 col-md-6 col-lg-3 wrapper-item-course">
													<div class="item-course color-2">
														...
														<div class="text">
															<div class="teacher">
																<div class="ava">
																	<img alt="Admin bar avatar" src="assets/uploads/learn-press-profile/5/2448c53ace919662a2b977d2be3a47c5.jpg" class="avatar avatar-68 photo" height="68" width="68" /> </div>
							...
							<div class="vc_column-inner">
								<div class="wpb_wrapper">
									<div class="bp-element bp-element-heading vc_custom_1542033381124 align-center layout-1  ">
										<h3 class="title" style="color:#7c7c7c; line-height:1.625; font-size:16px; font-weight:300; text-transform:none; margin:0 auto 5px auto; ">
											<?php echo $data['title']; ?> </h3>
										<span class="sub-title" style="color:#292929; line-height:1.25; font-size:35px; font-weight:400; text-transform:none; margin:0 auto 0px auto; ">Live the experience</span>
										<div class="line" style="height:2px; width:87px; background-color:#e1e1e1; "></div>
									</div>
    ...
    <div class="ob-google-map-canvas"
         id="ob-map-canvas-bc180dbc583491c00f8a1cd134f7517b" data-address='london'  data-zoom='12' data-scroll-zoom=''  data-draggable='' data-style='default'  data-api_key='AIzaSyA0rsuYtaOizexB6cCvcQSRIskctOGCCwo'></div>
				...
				<?php if ($data['application_status'] == '1') { ?>
        ...
        <div class="modal-body">
          <div class="vc_row wpb_row vc_row-fluid vc_custom_1539164509860 bp-background-size-auto">
						<div class="wpb_column vc_column_container vc_col-sm-12 bp-background-size-auto">
						 ...
						 <table cellspacing='0' class='table display data-table text-nowrap' style='width: 100%;'>
                    <thead>
                    <tr class='head'>
                    <th>
                    Campaign Name
                    ...
                    Action
						...
						echo "<tr>";
							...
							echo '</td>';
							echo '<td>';
							echo ' <input title="'.$row['id'].'"  class="btnShow btn btn-info btn-lg" type="button" id="btnShow" value="Apply Now" />';
							echo '</td>';
                        echo '</tr>';
										...
										<div class="vc_column-inner">
											<div class="wpb_wrapper">
												<div class="wpb_single_image wpb_content_element vc_align_left   max-width-163">
													<figure class="wpb_wrapper vc_figure">
														<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="336" height="276" src="<?php echo 'images/logo/' . $data['logo_image']; ?>" class="vc_single_image-img attachment-full" alt="" srcset="" sizes="(max-width: 336px) 100vw, 336px" /></div>
													</figure>
												</div>
											</div>
										</div>
							...
							<aside id="nav_menu-3" class="widget widget_nav_menu">
								<div class="menu-footer-1-container">
									<ul id="menu-footer-1" class="menu">
										<li id="menu-item-1222" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-17 current_page_item menu-item-1222 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="" class="tc-menu-inner">Home</a></li>
										<li id="menu-item-1223" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1223 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#aboutus" class="tc-menu-inner">About</a></li>
										<li id="menu-item-1226" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1226 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#announcement" class="tc-menu-inner">Announcement</a></li>
							...
							<aside id="nav_menu-4" class="widget widget_nav_menu">
								<div class="menu-footer-2-container">
									<ul id="menu-footer-2" class="menu">
										<li id="menu-item-1227" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1227 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#contactus" class="tc-menu-inner">Contact us</a></li>
										<li id="menu-item-1228" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1228 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#courses" class="tc-menu-inner">Courses</a></li>
										<li id="menu-item-1229" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1229 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="#events" class="tc-menu-inner">Events</a></li>
									</ul>
								</div>
							</aside>
						</div>
...
<li id="menu-item-1233" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1233 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default"><a href="index.html" class="tc-menu-inner">Programs</a></li>
 ...
 -->
	...
	<script type='text/javascript' src='assets/plugins/builderpress/assets/libs/waypoints/jquery.waypoints.min.js'></script>
	...
	<script type='text/javascript' src='assets/plugins/builderpress/assets/libs/owl-carousel/owl.carousel.min.js'></script>
	<script type='text/javascript' src='assets/plugins/builderpress/inc/elements/general/brands/assets/js/brands.js'></script>
	<div class="container">
  <h2>Large Modal</h2>
