                ...
                <div class="vc_row-full-width vc_clearfix" style="padding:20px;"></div>
                    ...
                    <div class="mobile-margin-0 wpb_column vc_column_container vc_col-sm-6 bp-background-size-auto">
                        <div class="vc_column-inner vc_custom_1540537006055">
                            <div class="container">
                                <div
                                    ...
                                    <span class="sub-title"
                                        style="max-width:501px; color:#292929; line-height:1.25; font-size:35px; font-weight:400; text-transform:none; margin:20px 0 0px auto; ">
                                        
                                        <?php echo ucwords($campaign_byid['name']).'  '.ucwords($campaign_byid['academic_year']);?>
                                    </span>
                                    <div class="line"
						 ...
						 <iframe id="application_view" width="1000"
    ...
    <div class="modal-content">
     ...
     <!-- Modal Footer -->
            <div class="modal-footer">
				...
				<button type="button" class="btn btn_css btn-primary btn-default" data-dismiss="modal" >Accept</button>
            </div>
    </div> 
