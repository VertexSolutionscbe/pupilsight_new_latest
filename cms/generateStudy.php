...
$sqlpt = "SELECT path, filename FROM pupilsightDocTemplate WHERE pupilsightSchoolYearID = " . $aid . " AND pupilsightProgramID = " . $pro['pupilsightProgramID'] . " AND type = 'Study Certificate' AND FIND_IN_SET('" . $pro['pupilsightYearGroupID'] . "', classIds) ";
