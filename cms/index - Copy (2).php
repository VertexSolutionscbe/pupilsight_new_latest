...
function sendOTP() {
	...
	if (number.length == 10 && number != null) {
		...
		$("#spnPhoneStatus").html('Please enter a valid number!');
		$('#spnPhoneStatus').css('color', 'red');
		$("#spnPhoneStatus").show();
	}
 ...
 -->
   ...
   <div class="modal" id="app_status">
        ...
        <div class="row">
			...
			<div class='formcss'>
                <form class='' onsubmit="event.preventDefault();" action="" id="frm-mobile-verification">
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
						    ...
						    <input class="mblnum" style="width:18%" pattern="^\d{10}$" maxlength="10" id="txtPhone" placeholder=""  name="txtPhone"  data-error="Please enter mobile number." id="inputName" required />
							 
						</div>
						<br/><span style="margin-left:204px" title="" id="spnPhoneStatus"></span>
				 </div>
				 <div class="row">
				  <div class="col-sm-4 col-lg-4">
				  <span class="" style="float:right"> OR </span>
				  </div>
				 </div>
				<div class="row">
				
						  <div class="col-sm-2 col-lg-2">
                            <span class="lablembl">Email :</span>
                        </div>
					<div class="col-sm-10 col-lg-10"> 						
                            <input class="mblnum" type="email"  placeholder=""  name="ver_email"  data-error="Please enter email" id="ver_email" required />
											
                            <button style="margin-left: 96px;" id="otpsend" type="submit" class="btnSubmit icon" onClick="sendOTP();"  value="Send OTP" >
                    ...
                    Action
						...
						echo "<tr>";
							...
							echo '</td>';
							echo '<td>';
							echo ' <a href="" title="'.$row['form_id'].'"  class="btnShow btn btn-info btn-lg" type="button" id="btnShow"  style="font-size: 14px;" ></a>';
							echo '</td>';
                        echo '</tr>';
