...
<header id="masthead" class="header_colr site-header affix-top header-overlay sticky-header custom-sticky has-retina-logo header_v2 transparent header_large">
    <div class="container">
        <div class="header-wrapper" style="padding-top: 17px; padding-bottom: 17px;">
            ...
            <nav class="width-navigation main-navigation">
                <ul id="primaryMenu">
                    <li id="menu-item-646" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home  menu-item-646 tc-menu-item tc-menu-depth-0 tc-menu-align-left tc-menu-layout-default">
