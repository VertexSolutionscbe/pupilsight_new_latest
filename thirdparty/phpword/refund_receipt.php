...
$file = $_SERVER["DOCUMENT_ROOT"]."/thirdparty/phpword/templates/refund_receipt.docx";
...
$savedocsx = $_SERVER["DOCUMENT_ROOT"]."/public/refundreceipts/".$dts["transactionId"].".docx";
//echo $savedocsx;
