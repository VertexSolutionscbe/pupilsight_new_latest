...
$file = $_SERVER["DOCUMENT_ROOT"]."/thirdparty/phpword/templates/cancel_receipt.docx";
...
$savedocsx = $_SERVER["DOCUMENT_ROOT"]."/public/cancelreceipts/".$dts["transactionId"].".docx";
//echo $savedocsx;
