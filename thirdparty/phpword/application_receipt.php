...
require_once $_SERVER["DOCUMENT_ROOT"] .
    "/pupilsight/vendor/phpoffice/phpword/bootstrap.php";

$file =
    $_SERVER["DOCUMENT_ROOT"] .
    "/pupilsight/public/application_fee_receipts/default/ApplicationFee_CBSE_Receipt.docx";
...
$savedocsx =
    $_SERVER["DOCUMENT_ROOT"] .
    "/public/application_fee_receipts/" .
    $dts["transactionId"] .
    ".docx";
...
function convert_number_to_words($number)
{
    ...
    switch (true) {
        ...
        default:
            ...
            $string =
                convert_number_to_words($numBaseUnits) .
                " " .
                $dictionary[$baseUnit];
            if ($remainder) {
