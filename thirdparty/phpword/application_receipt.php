...
$file = $_SERVER["DOCUMENT_ROOT"]."/pupilsight/public/application_fee_receipts/default/ApplicationFee_CBSE_Receipt.docx";
...
$savedocsx = $_SERVER["DOCUMENT_ROOT"]."/public/application_fee_receipts/".$dts["transactionId"].".docx";
