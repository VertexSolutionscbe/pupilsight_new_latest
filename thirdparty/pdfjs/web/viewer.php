...
<head>
  ...
  <script>
    //var pdfLink = "P0259.pdf";
    <?php
    $pdfFile = urldecode($_GET["src"]);
    //var pdfLink = "http://christacademy.pupilpod.net/public/applicationpdf/70-application.pdf";


    ?>
    var pdfLink = "<?php echo $pdfFile; ?>"; //call by viewr js
    var vs = Date.now();
  </script>

  <script src="viewer.js?v=<?= time(); ?>"></script>
    ...
    <div id="mainContainer">
      ...
      <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
        <div id="secondaryToolbarButtonContainer">
          ...
          <button id="secondaryOpenFile" class="secondaryToolbarButton openFile visibleLargeView hide" title="Open File" tabindex="52" data-l10n-id="open_file">
