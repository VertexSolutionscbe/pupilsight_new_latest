...
function exportMarksExcelByStudent() {
    try {
        var val = '';
        var type = 'studentMarks_excel_new';
        ...
        console.log("exportMarksExcelByStudent: " + ex);
    }
}

$("#exportExcelNew").click(function () {
    exportExcelBySubject();
});

function exportExcelBySubject() {
    try {
        var type = 'subjectMarks_excelNew';
        var section = $('#pupilsightRollGroupIDbyPPbyMarks').val();
        var cls = $('#pupilsightYearGroupIDbyPPbyMarks').val();
        ...
        console.log("exportExcelBySubject: " + ex);
    }
}