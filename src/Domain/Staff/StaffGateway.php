...
class StaffGateway extends QueryableGateway
{
    ...
    public function queryAllStaff(
        ...
        $query = $this->newQuery()
            ...
            ->cols([
                ...
                "assignstaff_toclasssection.pupilsightMappingID",
                "pupilsightProgramClassSectionMapping.pupilsightProgramID",
                "pupilsightPerson.title",
                "pupilsightPerson.surname",
                "pupilsightPerson.email",
                "pupilsightPerson.phone1",
                "pupilsightPerson.preferredName",
                "pupilsightPerson.status",
                "pupilsightPerson.username",
                "pupilsightPerson.image_240",
                "pupilsightPerson.canLogin",
                "pupilsightStaff.staff_status AS stat",
                "pupilsightStaff.pupilsightStaffID",
                "pupilsightPerson.pupilsightPersonID AS stuid",
                "pupilsightStaff.initials",
                "pupilsightStaff.type",
                "pupilsightStaff.jobTitle",
                "pupilsightPerson.passwordStrong as stfPassword",
                "pupilsightPerson.username as stfUsername",
            ...
            ->innerJoin(
                "pupilsightPerson",
                "pupilsightPerson.pupilsightPersonID=pupilsightStaff.pupilsightPersonID"
            )
            ->leftJoin(
                "assignstaff_toclasssection",
                "assignstaff_toclasssection.pupilsightPersonID=pupilsightStaff.pupilsightPersonID"
            )
            ->leftJoin(
                "pupilsightProgramClassSectionMapping",
                "pupilsightProgramClassSectionMapping.pupilsightMappingID=assignstaff_toclasssection.pupilsightMappingID"
            )
            ->leftJoin(
                "assignstaff_tosubject",
                "assignstaff_tosubject.pupilsightStaffID=pupilsightStaff.pupilsightStaffID"
            );
        ...
        if (!empty($pupilsightDepartmentID)) {
            $query->where(
                'assignstaff_tosubject.pupilsightdepartmentID = "' .
    ...
    public function selectStaffByID($pupilsightPersonID, $type = null)
    {
        ...
        if (!empty($type)) {
            $sql .= " AND pupilsightStaff.type='Teaching'";
        }
    ...
    public function getStudentData(
        ...
        if (!empty($pupilsightProgramID)) {
            $query = $this->newQuery()
                ...
                ->cols([
                    "pupilsightProgramClassSectionMapping.pupilsightMappingID AS stuid",
            ...
            if (!empty($pupilsightRollGroupID)) {
                ...
                $query->where(
                    "pupilsightProgramClassSectionMapping.pupilsightRollGroupID IN (" .
                        $rollIds .
                        ") "
                );
            }
            ...
            $query->orderBy([
                "pupilsightProgramClassSectionMapping.pupilsightYearGroupID ASC",
            ]);
        } else {
            $query = $this->newQuery()
                ->distinct()
    ...
    public function getStaff(QueryCriteria $criteria)
    {
        $query = $this->newQuery()
            ...
            ->cols([
                ...
                "pupilsightStaff.pupilsightStaffID",
                "pupilsightPerson.email",
                "pupilsightPerson.phone1 AS phone",
                "pupilsightStaff.staff_status",
                "pupilsightPerson.pupilsightPersonID AS staffid",
                "pupilsightStaff.initials",
                "pupilsightStaff.type",
                "pupilsightStaff.jobTitle",
            ])
    ...
    public function getassignedstaff(
        ...
        $query = $this->newQuery()
            ...
            ->cols([
                "assignstaff_toclasssection.id AS st_id",
                "assignstaff_toclasssection.pupilsightMappingID",
                "pupilsightProgram.name AS program",
                "pupilsightYearGroup.nameShort AS yearGroup",
                "GROUP_CONCAT(DISTINCT pupilsightPerson.pupilsightPersonID) as pid",
                "pupilsightRollGroup.nameShort AS rollGroup",
            ])
            ...
            ->leftJoin(
                "pupilsightPerson",
                "assignstaff_toclasssection.pupilsightPersonID=pupilsightPerson.pupilsightPersonID"
            )
            ->where(
                "pupilsightProgramClassSectionMapping.pupilsightSchoolYearID = " .
                    $pupilsightSchoolYearID .
            ...
            ->groupBy([
                "pupilsightProgramClassSectionMapping.pupilsightMappingID",
            ]);
        //echo $query;
        ...
        foreach ($data as $k => $sd) {
            if (!empty($sd["pid"])) {
                $query2 = $this->newQuery()
                    ...
                    ->where(
                        "pupilsightPerson.pupilsightPersonID IN (" .
                            $sd["pid"] .
                            ") "
                    );
        ...
        if ($subType == "Elective") {
            $query = $this->newQuery()
                ...
                ->cols([
                    ...
                    "GROUP_CONCAT(assignstudent_tostaff.pupilsightStaffID) AS staffIds",
                ])

                ->leftJoin(
                    "assignstudent_tostaff",
                    "pupilsightPerson.pupilsightPersonID=assignstudent_tostaff.pupilsightPersonID"
                )
                ->leftJoin(
                ...
                ->leftJoin(
                    ...
                    "pupilsightStudentEnrolment.pupilsightSchoolYearID=pupilsightSchoolYear.pupilsightSchoolYearID"
                )
                ->leftJoin(
                    "pupilsightRollGroup",
                ...
                ->leftJoin(
                    "assign_elective_subjects_tostudents",
                    "pupilsightPerson.pupilsightPersonID=assign_elective_subjects_tostudents.pupilsightPersonID"
                );

            if (!empty($pupilsightProgramID)) {
                $query->where(
                    'pupilsightProgram.pupilsightProgramID = "' .
                        $pupilsightProgramID .
                        '" '
                );
            }
            ...
            if (!empty($pupilsightDepartmentID)) {
                $query->where(
                    'assign_elective_subjects_tostudents.pupilsightDepartmentID = "' .
                        $pupilsightDepartmentID .
                        '" '
                );
            }
            ...
            if (!empty($pupilsightProgramID)) {
                ...
                $query = $this->newQuery()
                    ...
                    ->cols([
                        "pupilsightPerson.pupilsightPersonID AS stuid",
                        "pupilsightPerson.officialName AS student_name",
                        "GROUP_CONCAT(DISTINCT assignstudent_tostaff.pupilsightStaffID SEPARATOR ', ') as staff_id",
                        "assignstudent_tostaff.pupilsightStaffID AS Staffid",
                        "stf.officialName as staff_name",
                    ])
                    ->leftJoin(
                        "assignstudent_tostaff",
                        "pupilsightPerson.pupilsightPersonID=assignstudent_tostaff.pupilsightPersonID"
                    ...
                    ->leftJoin(
                        "pupilsightPerson AS stf",
                        "assignstudent_tostaff.pupilsightStaffID=stf.pupilsightPersonID"
                    )
                    ->where(
                        'pupilsightPerson.pupilsightRoleIDAll = "' .
                            $pupilsightRoleIDAll .
    ...
    public function getStaffByFilter(QueryCriteria $criteria, $staffIds, $pupilsightSchoolYearID,  $pupilsightProgramID, $pupilsightYearGroupID, $pupilsightRollGroupID)
    {
        $query = $this->newQuery()
            ...
            ->leftJoin(
                ...
                "assignstaff_tosubject.subjectToClassCurriculumID=subjectToClassCurriculum.id"
            )
            ->leftJoin(
                "pupilsightProgram",
                "subjectToClassCurriculum.pupilsightProgramID=pupilsightProgram.pupilsightProgramID"
            )
            ->leftJoin(
                "pupilsightYearGroup",
    ...
    public function getFeedbackCategory(QueryCriteria $criteria)
    {
        $query = $this->newQuery()
            ...
            ->cols(["pupilsightFeedbackCategory.*"])
    ...
    public function getFeedback(QueryCriteria $criteria, $staff_id)
    {
        $query = $this->newQuery()
            ...
            ->cols([
                "pupilsightFeedback.*",
                "pupilsightFeedbackCategory.name as catName",
                "pupilsightDepartment.name as subjectName",
                "pupilsightProgram.name AS program",
            ...
            ->leftJoin(
                ...
                "pupilsightFeedback.category_id=pupilsightFeedbackCategory.id"
            )
            ->leftJoin(
                "pupilsightProgram",
                "pupilsightFeedback.pupilsightProgramID=pupilsightProgram.pupilsightProgramID"
            )
            ->leftJoin(
                "pupilsightYearGroup",
                "pupilsightFeedback.pupilsightYearGroupID=pupilsightYearGroup.pupilsightYearGroupID"
            )
            ->leftJoin(
                "pupilsightRollGroup",
                "pupilsightFeedback.pupilsightRollGroupID=pupilsightRollGroup.pupilsightRollGroupID"
            )
            ->leftJoin(
                "pupilsightDepartment",
                "pupilsightFeedback.pupilsightdepartmentID=pupilsightDepartment.pupilsightDepartmentID"
            )
            ->where(
                "pupilsightFeedback.pupilsightPersonID = " . $staff_id . " "
            )
    ...
    public function getStaffByFilterOld(QueryCriteria $criteria, $staffIds, $pupilsightSchoolYearID,  $pupilsightProgramID, $pupilsightYearGroupID, $pupilsightRollGroupID)
    {
        $query = $this->newQuery()
        ->from("assignstaff_tosubject")
        ->cols([
