...
class StudentGateway extends QueryableGateway
{
    ...
    public function queryStudentsBySchoolYear(QueryCriteria $criteria, $pupilsightSchoolYearID = NULL, $searchFamilyDetails = false, $pupilsightProgramID = NULL, $pupilsightYearGroupID = NULL, $pupilsightRollGroupID = NULL, $search = NULL)
    {
        ...
        $query = $this
            ...
            ->cols([
                'pupilsightPerson.pupilsightPersonID', "CASE WHEN (pupilsightPerson.active='1') THEN 'Active' ELSE 'Inactive'  END as active_status", 'pupilsightPerson.pupilsightPersonID as student_id', 'pupilsightPerson.dob', 'pupilsightStudentEnrolmentID', 'pupilsightPerson.title', 'pupilsightPerson.preferredName', 'pupilsightPerson.surname', 'pupilsightPerson.officialName', 'pupilsightPerson.image_240', 'pupilsightYearGroup.name AS yearGroup', 'pupilsightRollGroup.nameShort AS rollGroup', 'pupilsightStudentEnrolment.rollOrder', 'pupilsightPerson.dateStart', 'pupilsightPerson.dateEnd', 'pupilsightPerson.status', "'Student' as roleCategory", 'pupilsightSchoolYear.name as academic_year', 'pupilsightProgram.name as program', 'pupilsightPerson.gender', 'pupilsightPerson.username', 'pupilsightPerson.address1', 'pupilsightPerson.address1District', 'pupilsightPerson.address1Country', 'pupilsightPerson.phone1', 'pupilsightPerson.languageFirst', 'pupilsightPerson.languageSecond', 'pupilsightPerson.languageThird', 'pupilsightPerson.religion', 'pupilsightPerson.admission_no', 'pupilsightPerson.active', 'parent1.officialName as fatherName', 'parent1.email as fatherEmail', 'parent1.phone1 as fatherPhone', 'parent2.officialName as motherName', 'parent2.email as motherEmail', 'parent2.phone1 as motherPhone'
            ])
