...
class StudentGateway extends QueryableGateway
{
     ...
     * @return DataSet
     */
    public function queryStudentsBySchoolYear(QueryCriteria $criteria, $pupilsightSchoolYearID = NULL, $searchFamilyDetails = false, $pupilsightProgramID = NULL, $pupilsightYearGroupID = NULL, $pupilsightRollGroupID = NULL, $search = NULL, $customFieldNames = NULL)
    {
...
*/
        ...
        $query = $this
            ...
            ->cols([
                "CASE WHEN (pupilsightPerson.active='1') THEN 'Active' ELSE 'Inactive'  END AS active_status", 'pupilsightPerson.pupilsightPersonID AS student_id', 'pupilsightStudentEnrolmentID', 'pupilsightYearGroup.name AS yearGroup', 'pupilsightRollGroup.nameShort AS rollGroup', 'pupilsightStudentEnrolment.rollOrder', "'Student' AS roleCategory", 'pupilsightSchoolYear.name AS academic_year', 'pupilsightProgram.name AS program', 'parent1.officialName AS fatherName', 'parent1.username AS fatherUserName',  'parent1.email AS fatherEmail', 'parent1.phone1 AS fatherPhone', 'parent2.officialName AS motherName', 'parent2.username AS motherUserName', 'parent2.email AS motherEmail', 'parent2.phone1 AS motherPhone', 'pupilsightPerson.pupilsightPersonID', 'pupilsightPerson.admission_no',
