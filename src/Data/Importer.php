...
class Importer
{
     ...
     * @return  bool
     */
    public function createImportLog($pupilsightPersonID, $type, $results = [], $columnOrder = [])
    {
        ...
        $sql = "INSERT INTO pupilsightLog SET pupilsightSchoolYearID=(SELECT pupilsightSchoolYearID FROM pupilsightSchoolYear WHERE status='Current'), pupilsightModuleID=(SELECT pupilsightModuleID FROM pupilsightModule WHERE name='System Admin'), pupilsightPersonID=:pupilsightPersonID, title=:title, serialisedArray=:serialisedArray, ip=:ip";
