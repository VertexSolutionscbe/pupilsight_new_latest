...
class Excel extends \PHPExcel
{
	...
	function exportWithQuery($result, $excel_file_name)
	{
		...
		$this->getProperties()->setTitle("Pupilsight Query Dump");
		$this->getProperties()->setSubject("Pupilsight Query Dump");
		$this->getProperties()->setDescription("Dump of Query Results generated by Pupilsight");
	...
	{
		$this->getProperties()->setCreator(__(NULL, "Pupilsight Edu using PHPExcel"));
		$this->getProperties()->setLastModifiedBy(__(NULL, "Pupilsight"));
		...
		$this->getProperties()->setDescription(__(NULL, 'This information is confidential. Generated by Pupilsight (http://pupilsight.in).'));
