...
class FormFactory implements FormFactoryInterface
{
    ...
    public function createCheckbox($name, $rightAlign=TRUE)
    {
        if($rightAlign){
    ...
    public function createCustomBlocks($name, \Pupilsight\Session $session)
    {
    ...
    {
        $content = sprintf('<input type="submit" class="btn btn-primary" value="%s">', __($label));
