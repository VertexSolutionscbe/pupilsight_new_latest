 ...
 * @since   v18
 */
class DataTableViewResult extends View implements RendererInterfaceResult
{
    /**
     * Render the table to HTML.
     *
     * @param DataTableResult $table
     ...
     * @param DataTableResult $table
     */
    protected function preProcessTable(DataTableResult $table)
    {
     ...
     * @return array
     */
    protected function getTableHeaders(DataTableResult $table)
    {
        $headers = [];
     ...
     * @return array
     */
    protected function getTableRows(DataTableResult $table, DataSet $dataSet)
    {
        $rows = [];
     ...
     * @return Element
     */
    protected function createTableRow(array $data, DataTableResult $table)
    {
        $row = new Element();
     ...
     * @return Element
     */
    protected function createTableCell(array $data, DataTableResult $table, Column $column)
    {
        $cell = new Element();
