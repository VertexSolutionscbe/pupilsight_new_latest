...
$output .=
    "tinymce.execCommand(\"mceFocus\",false,\"$id\"); tinyMCE.execCommand(\"mceInsertContent\", 0, response); formReset(); \$(\"." .
    $id .
    'resourceQuickSlider").slideUp();';
$output .= '}, ';
$output .=
    "url: '" .
...
$output .=
    '$(".' .
    $id .
    "resourceQuickSlider\").html(\"<div class='resourceAddSlider'><img style='margin: 10px 0 5px 0' src='" .
    $_SESSION[$guid]['absoluteURL'] .
    '/themes/' .
    $_SESSION[$guid]['pupilsightThemeName'] .
    "/img/loading.gif' alt='" .
    __('Uploading') .
...
$row
    ->addSelect('imagesAsLinks')
    ->fromArray(['N' => __('Image'), 'Y' => __('Link')])
    ->required();
