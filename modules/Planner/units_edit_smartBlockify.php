            ...
            if ($result->rowCount() != 1) {
                ...
                if ($pupilsightUnitID == '') {
                    ...
                    if ($result->rowCount() != 1) {
                        ...
                        ?>
						<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/units_edit_smartBlockifyProcess.php?pupilsightUnitID=$pupilsightUnitID&pupilsightCourseID=$pupilsightCourseID&pupilsightCourseClassID=$pupilsightCourseClassID&pupilsightSchoolYearID=$pupilsightSchoolYearID" ?>">
							<table cellspacing='0' style="width: 100%">
								...
								<tr>
									<td>
										...
										<input name="pupilsightUnitClassID" id="pupilsightUnitClassID" value="<?php echo $pupilsightUnitClassID ?>" type="hidden">
