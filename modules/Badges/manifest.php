...
$moduleTables[0] = "CREATE TABLE `badgesBadge` (
  ...
  `pupilsightPersonIDCreator` int(8) unsigned zerofill NOT NULL,
...
$moduleTables[1] = 'CREATE TABLE `badgesBadgeStudent` (
  ...
  `pupilsightPersonIDCreator` int(10) unsigned zerofill NULL DEFAULT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	PRIMARY KEY (`badgesBadgeStudentID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;';

//Settings
$moduleTables[2] = "INSERT INTO `pupilsightSetting` (`pupilsightSettingID` ,`scope` ,`name` ,`nameDisplay` ,`description` ,`value`) VALUES (NULL , 'Badges', 'badgeCategories', 'Badge Categories', 'Comma-separated list of available choices for badge category.', 'Academic,Athletic,Social,Other');";
...
$hooks[0] = "INSERT INTO `pupilsightHook` (`pupilsightHookID`, `name`, `type`, `options`, pupilsightModuleID) VALUES (NULL, 'Badges', 'Student Profile', '".serialize($array)."', (SELECT pupilsightModuleID FROM pupilsightModule WHERE name='$name'));";

$array = array();
$array['sourceModuleName'] = 'Badges';
$array['sourceModuleAction'] = 'View Badges_myChildren';
$array['sourceModuleInclude'] = 'hook_parentalDashboard_badgesView.php';
$hooks[1] = "INSERT INTO `pupilsightHook` (`pupilsightHookID`, `name`, `type`, `options`, pupilsightModuleID) VALUES (NULL, 'Badges', 'Parental Dashboard', '".serialize($array)."', (SELECT pupilsightModuleID FROM pupilsightModule WHERE name='$name'));";
