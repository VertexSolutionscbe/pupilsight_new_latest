...
if (isActionAccessible($guid, $connection2, '/modules/Badges/badges_grant_delete.php') == false) {
    ...
    if ($badgesBadgeStudentID == '') { echo "<div class='error'>";
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($pupilsight->session->get('absoluteURL','').'/modules/'.$pupilsight->session->get('module')."/badges_grant_deleteProcess.php?badgesBadgeStudentID=$badgesBadgeStudentID&pupilsightPersonID2=".$_GET['pupilsightPersonID2'].'&badgesBadgeID2='.$_GET['badgesBadgeID2']."&pupilsightSchoolYearID=$pupilsightSchoolYearID");
            echo $form->getOutput();
        }
    }
}
