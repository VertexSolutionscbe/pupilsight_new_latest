...
$URL = $pupilsight->session->get('absoluteURL','').'/index.php?q=/modules/'.getModuleName($_POST['address']).'/badgeSettings.php';
...
if (isActionAccessible($guid, $connection2, '/modules/Badges/badgeSettings.php') == false) {
    ...
    if ($badgeCategories == '') {
        ...
        try {
            ...
            $sql = "UPDATE pupilsightSetting SET value=:value WHERE scope='Badges' AND name='badgeCategories'";
