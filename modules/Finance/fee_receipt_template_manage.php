...
if (isActionAccessible($guid, $connection2, '/modules/Academics/fee_receipts_manage.php') == false) {
    //Acess denied
   ...
   echo "<div style='height:50px;'><div class='float-right mb-2'><a href='fullscreen.php?q=/modules/Academics/fee_receipt_template_add.php' class='thickbox btn btn-primary'>Add</a>
