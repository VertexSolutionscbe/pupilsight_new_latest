...
if (isActionAccessible($guid, $connection2, '/modules/Finance/invoice_manage_add.php') == false) {
    ...
    $form = Form::create('program', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/invoice_manage_addProcess.php');
    ...
    $row = $form->addRow();
        ...
        //     $col->addSelect('invoice_title_id')->fromArray($feeSeriesData)->required();    
