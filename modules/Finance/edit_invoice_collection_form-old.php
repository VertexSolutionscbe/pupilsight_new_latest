   ...
   // $id = $_GET['id'];
    ...
    if ($id == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $datac = array('fn_fee_invoice_id' => $id);
            ...
            $form = Form::create('edit_invoice_save_form', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/edit_invoice_save_collection.php');
            $form->setFactory(DatabaseFormFactory::create($pdo));

            $form->addHiddenValue('address', $_SESSION[$guid]['address']);
            $form->addHiddenValue('invoice_id', $id);
            $form->addHiddenValue('old_title', $values['title']);
            ...
            $row = $form->addRow();
                $col = $row->addColumn()->setClass('newdes');
                   ...
                   /* $col->addLabel('transaction_editable', __('Transaction editable'));
                    ...
                    $col->addContent('<input type="checkbox" name="transaction_editable" '.$cl.'>'); */   
            ...
            if(!empty($childvalues)){
                ...
                foreach($childvalues as $cv){
                    ...
                    if($i == '1'){
                        ...
                        $col->addTextField('discount['.$cv['id'].']')->addClass('txtfield kountseat numfield')->setValue($cv['discount']);    
                ...
                $col = $row->addColumn()->setClass('newdes nobrdbtm');
                    $col->addLabel('discount', __('Discount'))->addClass('dte');
                    $col->addTextField('discount[1]')->addClass('txtfield kountseat numfield');    
