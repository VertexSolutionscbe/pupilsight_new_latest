...
if (isActionAccessible($guid, $connection2, '/modules/Finance/budgets_manage_delete.php') == false) {
    ...
    if ($pupilsightFinanceBudgetID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/budgets_manage_deleteProcess.php?pupilsightFinanceBudgetID=$pupilsightFinanceBudgetID");
            echo $form->getOutput();
        }
    }
}
