...
if (isActionAccessible($guid, $connection2, '/modules/Finance/expenseApprovers_manage_delete.php') == false) {
    ...
    if ($pupilsightFinanceExpenseApproverID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/expenseApprovers_manage_deleteProcess.php?pupilsightFinanceExpenseApproverID=$pupilsightFinanceExpenseApproverID");
            echo $form->getOutput();
        }
    }
}
