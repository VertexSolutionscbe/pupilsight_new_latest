   ...
   var pupilsightRollGroupID = $("#pupilsightRollGroupID").val();
    var type ="exportExcelSummary_byDate";
     $.ajax({
        ...
        type: 'post',
        data: { dateStart: dateStart, dateEnd: dateEnd, pupilsightProgramID: pupilsightProgramID,pupilsightYearGroupID:pupilsightYearGroupID,pupilsightRollGroupID:pupilsightRollGroupID,countClassAsSchool:countClassAsSchool,type:type },
        async: true,
