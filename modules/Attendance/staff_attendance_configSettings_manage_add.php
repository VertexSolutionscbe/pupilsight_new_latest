...
if (isActionAccessible($guid, $connection2, '/modules/Attendance/staff_attendance_configSettings_manage_add.php') == false) {
    ...
    $page->breadcrumbs
        ...
        ->add(__('Add Staff Attendance Configuration'));
    ...
    $form = Form::create('attendanceConfigSetting', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/staff_attendance_configSettings_manage_addProcess.php');
