...
if (isActionAccessible($guid, $connection2, '/modules/Attendance/attendance_configSettings.php') == false) {
    //Acess denied
    ...
    ->setURL('/modules/Attendance/attendance_configSettings_manage_add.php')
    ->displayLabel();
   
    //$table->addColumn('sequenceNumber', __('sequenceNumber'));
    /*$table->addColumn('program_name', __('Organisation'));
    $table->addColumn('attn_type', __('Attendance Type'))
         ->format(function ($dataSet) {
             if ($dataSet['attn_type'] == '1') {
                 return 'Session';
             } else {
                return 'Subject';
             }
             return $dataSet['attn_type'];
    });  
    ...
    $table->addActionColumn()
        ...
        ->format(function ($facilities, $actions) use ($guid) {
            $actions->addAction('edit', __('Edit'))
                    ->setURL('/modules/Attendance/attendance_configSettings_manage_edit.php');

            $actions->addAction('delete', __('Delete'))
                    ->setURL('/modules/Attendance/attendance_configSettings_manage_delete.php');
        });*/
    ...
    <table class='table'>
        ...
        <tbody>
            <?php foreach ($dataSet as $val) { 
                $edit=$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Attendance/attendance_configSettings_manage_edit.php&id=".$val['id'];
...
<script type="text/javascript">
    $(document).on('click','.del_data',function(){
       ...
       var type ="del_attendance_configSettings";
