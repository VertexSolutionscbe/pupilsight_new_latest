        ...
        echo "<table class='timetable ' style='width:100% !important' border='1'>  <tr>               
                ...
                <select name='type[]' class='w-full'>";
                 foreach ($types as $val) {
                     ?>
                     <option value="<?php echo $val['name'];?>" <?php if(!empty($rowCheck)){ if($val['name']==$rowCheck['type']){ echo "selected";} } ?> ><?php echo $val['name'];?></option>
                     <?php 
                 }
                echo "</select></td>";
                echo "<td>
                <select name='reasons[]' class='w-full'>";
                 foreach ($reasons as $val) {
                     ?>
                     <option value="<?php echo $val;?>" <?php if(!empty($rowCheck)){ if($val==$rowCheck['reason']){ echo "selected";} } ?>><?php echo $val;?></option>
                     <?php 
                 }
                echo "</select></td>";
