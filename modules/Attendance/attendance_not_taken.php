...
// set page breadcrumb
$page->breadcrumbs->add(__('Attendance Not Taken'));

if (isActionAccessible($guid, $connection2, '/modules/Attendance/attendance_not_taken.php') == false) {
    //Acess denied
...
//select subjects from department
    ...
    $form->addHiddenValue('q', "/modules/".$_SESSION[$guid]['module']."/attendance_not_taken.php");
...
echo '</p>';
        ...
        echo '</th>';
        echo '<th style="width:80px" rowspan=2>';
        echo __('Morning Session');
        echo '</th>';
        echo '<th style="width:80px" rowspan=2>';
        echo __('Afternoon Session');
        echo '</th>';
        ...
        $nottaken = array_diff($datevalue, $data_array); 
            ...
            foreach($nottaken as $not) {
                // ROW                    
                    ...
                    echo '</td>';
                    echo '<td>';
                    echo '<i class="mdi mdi-close-thick"></i>';
                    echo '</td>';
                    echo '</td>';
                    echo '<td>';
                    echo '<i class="mdi mdi-close-thick"></i>';
