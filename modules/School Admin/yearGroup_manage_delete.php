...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/yearGroup_manage_delete.php') == false) {
    ...
    if ($pupilsightYearGroupID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/yearGroup_manage_deleteProcess.php?pupilsightYearGroupID=$pupilsightYearGroupID", true);
            echo $form->getOutput();
        }
    }
}
