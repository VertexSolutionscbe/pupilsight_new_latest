...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/inSettings_delete.php') == false) {
    ...
    if ($pupilsightINDescriptorID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/inSettings_deleteProcess.php?pupilsightINDescriptorID=$pupilsightINDescriptorID");
            echo $form->getOutput();
        }
    }
}
