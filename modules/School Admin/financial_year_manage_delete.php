...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/financial_year_manage_delete.php') == false) {
    ...
    if ($pupilsightSchoolFinanceYearID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/financial_year_manage_deleteProcess.php?pupilsightSchoolFinanceYearID=$pupilsightSchoolFinanceYearID", true);
            echo $form->getOutput();
        }
    }
}
