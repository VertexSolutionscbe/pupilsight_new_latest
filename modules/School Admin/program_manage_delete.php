...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/program_manage_delete.php') == false) {
    ...
    if ($pupilsightProgramID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/program_manage_deleteProcess.php?pupilsightProgramID=$pupilsightProgramID", true);
            echo $form->getOutput();
        }
    }
}
