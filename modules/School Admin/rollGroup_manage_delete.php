...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/rollGroup_manage_delete.php') == false) {
    ...
    if ($pupilsightRollGroupID == '' and $pupilsightSchoolYearID == '') {
        echo "<div class='alert alert-danger'>";
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/rollGroup_manage_deleteProcess.php?pupilsightRollGroupID=$pupilsightRollGroupID", true);
            echo $form->getOutput();
        }
    }
}
