...
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address']).'/schoolYear_manage.php';
...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/schoolYear_manage_add.php') == false) {
    ...
    if ($name == '' or $status == '' or $sequenceNumber == '' or is_numeric($sequenceNumber) == false or $firstDay == '' or $lastDay == '') {
        ...
        try {
            ...
            $sql = 'SELECT * FROM pupilsightSchoolYear WHERE name=:name OR sequenceNumber=:sequenceNumber OR firstDay=:firstDay OR lastDay=:lastDay';
