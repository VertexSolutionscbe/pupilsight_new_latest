...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/mapping_manage_delete.php') == false) {
    ...
    if ($pupilsightMappingID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/mapping_manage_deleteProcess.php?pupilsightMappingID=$pupilsightMappingID", true);
            echo $form->getOutput();
        }
    }
}
