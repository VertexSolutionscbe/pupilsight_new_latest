...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/schoolYear_manage_delete.php') == false) {
    ...
    if ($pupilsightSchoolYearID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/schoolYear_manage_deleteProcess.php?pupilsightSchoolYearID=$pupilsightSchoolYearID", true);
            echo $form->getOutput();
        }
    }
}
