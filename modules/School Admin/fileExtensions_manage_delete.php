...
if (isActionAccessible($guid, $connection2, '/modules/School Admin/fileExtensions_manage_delete.php') == false) {
    ...
    if ($pupilsightFileExtensionID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/fileExtensions_manage_deleteProcess.php?pupilsightFileExtensionID=$pupilsightFileExtensionID");
            echo $form->getOutput();
        }
    }
}
