...
if ($pupilsightPersonID == '' or $pupilsightCourseClassID == '' or $pupilsightSchoolYearID == '') { echo 'Fatal error loading this page!';
} else {
    ...
    $URLDelete = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address'])."/courseEnrolment_manage_byPerson_edit.php&type=$type&pupilsightPersonID=$pupilsightPersonID&pupilsightSchoolYearID=$pupilsightSchoolYearID&pupilsightCourseClassID=$pupilsightCourseClassID&allUsers=$allUsers&search=$search";
