...
if (isActionAccessible($guid, $connection2, '/modules/Timetable Admin/ttColumn_delete.php') == false) {
    ...
    if ($pupilsightTTColumnID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/ttColumn_deleteProcess.php?pupilsightTTColumnID=$pupilsightTTColumnID", true);
            echo $form->getOutput();
        }
    }
}
