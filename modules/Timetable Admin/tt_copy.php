...
if (isActionAccessible($guid, $connection2, '/modules/Timetable Admin/tt_copy.php') != false) {
    //Acess denied
...
//get All class
    ...
    if ($pupilsightSchoolYearID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = Form::create('action', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/tt_copyProcess.php');
            ...
            $row = $form->addRow();
                ...
                $row->addSelect('pupilsightYearGroupID')->fromArray($classes)->required();
