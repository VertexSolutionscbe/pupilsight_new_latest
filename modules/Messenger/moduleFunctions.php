...
function getMessages($guid, $connection2, $mode = '', $date = '')
{
    ...
    if ($sqlWhere != '(') {
        ...
        $dataPosts['date2'] = $date;
        $dataPosts['date3'] = $date;
        $sqlPosts = $sqlPosts." UNION (SELECT DISTINCT pupilsightMessenger.*, title, surname, preferredName, authorRole.category AS category, image_240, concat('Role Category: ', pupilsightRole.category) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole AS authorRole ON (pupilsightPerson.pupilsightRoleIDPrimary=authorRole.pupilsightRoleID) JOIN pupilsightRole ON (pupilsightMessengerTarget.id=pupilsightRole.category) WHERE pupilsightMessengerTarget.type='Role Category' AND (messageWall_date1=:date1 OR messageWall_date2=:date2 OR messageWall_date3=:date3) AND $sqlWhere)";
    }
    ...
    if ($student) {
        ...
        $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Year Group ', pupilsightYearGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightYearGroup ON (pupilsightStudentEnrolment.pupilsightYearGroupID=pupilsightYearGroup.pupilsightYearGroupID) WHERE pupilsightStudentEnrolment.pupilsightPersonID=:pupilsightPersonID1 AND pupilsightMessengerTarget.type='Year Group' AND (messageWall_date1=:date7 OR messageWall_date2=:date8 OR messageWall_date3=:date9) AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID1 AND students='Y')";
    }
    if ($parent and $children != false) {
        ...
        $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Year Group: ', pupilsightYearGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightYearGroup ON (pupilsightStudentEnrolment.pupilsightYearGroupID=pupilsightYearGroup.pupilsightYearGroupID) WHERE ".preg_replace('/pupilsightPersonID/', 'pupilsightStudentEnrolment.pupilsightPersonID', $children)." AND pupilsightMessengerTarget.type='Year Group' AND (messageWall_date1=:date10 OR messageWall_date2=:date11 OR messageWall_date3=:date12) AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID2 AND parents='Y')";
    }
    ...
    if ($staff) {
        ...
        if ($resultRollGroup->rowCount() > 0) {
            ...
            if ($sqlWhere != '(') {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Roll Group: ', pupilsightRollGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightRollGroup ON (pupilsightMessengerTarget.id=pupilsightRollGroup.pupilsightRollGroupID) WHERE pupilsightMessengerTarget.type='Roll Group' AND (messageWall_date1=:date13 OR messageWall_date2=:date14 OR messageWall_date3=:date15) AND $sqlWhere AND staff='Y')";
            }
        }
    }
    if ($student) {
    ...
    if ($resultClasses->rowCount() > 0) {
        ...
        if ($sqlWhere != '(') {
            if ($staff) {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Course: ', pupilsightCourse.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourse ON (pupilsightMessengerTarget.id=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Course' AND (messageWall_date1=:date22 OR messageWall_date2=:date23 OR messageWall_date3=:date24) AND $sqlWhere AND staff='Y')";
            }
            if ($student) {
                $dataPosts['date25'] = $date;
                $dataPosts['date26'] = $date;
                $dataPosts['date27'] = $date;
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Course: ', pupilsightCourse.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourse ON (pupilsightMessengerTarget.id=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Course' AND (messageWall_date1=:date25 OR messageWall_date2=:date26 OR messageWall_date3=:date27) AND $sqlWhere AND students='Y')";
            }
        }
    }
    if ($parent and $children != false) {
        ...
        if ($resultClasses->rowCount() > 0) {
            ...
            if ($sqlWhere != '(') {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Course: ', pupilsightCourse.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourse ON (pupilsightMessengerTarget.id=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Course' AND (messageWall_date1=:date28 OR messageWall_date2=:date29 OR messageWall_date3=:date30) AND $sqlWhere AND parents='Y')";
            }
        }
    }
    ...
    if ($resultClasses->rowCount() > 0) {
        ...
        if ($sqlWhere != '(') {
            if ($staff) {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Class: ', pupilsightCourse.nameShort, '.', pupilsightCourseClass.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourseClass ON (pupilsightMessengerTarget.id=pupilsightCourseClass.pupilsightCourseClassID) JOIN pupilsightCourse ON (pupilsightCourseClass.pupilsightCourseID=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Class' AND (messageWall_date1=:date31 OR messageWall_date2=:date32 OR messageWall_date3=:date33) AND $sqlWhere AND staff='Y')";
            }
            if ($student) {
                $dataPosts['date34'] = $date;
                $dataPosts['date35'] = $date;
                $dataPosts['date36'] = $date;
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Class: ', pupilsightCourse.nameShort, '.', pupilsightCourseClass.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourseClass ON (pupilsightMessengerTarget.id=pupilsightCourseClass.pupilsightCourseClassID) JOIN pupilsightCourse ON (pupilsightCourseClass.pupilsightCourseID=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Class' AND (messageWall_date1=:date34 OR messageWall_date2=:date35 OR messageWall_date3=:date36) AND $sqlWhere AND students='Y')";
            }
        }
    }
    if ($parent and $children != false) {
        ...
        if ($resultClasses->rowCount() > 0) {
            ...
            if ($sqlWhere != '(') {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Class: ', pupilsightCourse.nameShort, '.', pupilsightCourseClass.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightCourseClass ON (pupilsightMessengerTarget.id=pupilsightCourseClass.pupilsightCourseClassID) JOIN pupilsightCourse ON (pupilsightCourseClass.pupilsightCourseID=pupilsightCourse.pupilsightCourseID) WHERE pupilsightMessengerTarget.type='Class' AND (messageWall_date1=:date37 OR messageWall_date2=:date38 OR messageWall_date3=:date39) AND $sqlWhere AND parents='Y')";
            }
        }
    }
    ...
    if ($staff) {
        ...
        if ($resultActivities->rowCount() > 0) {
            ...
            if ($sqlWhere != '(') {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Activity: ', pupilsightActivity.name) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightActivity ON (pupilsightMessengerTarget.id=pupilsightActivity.pupilsightActivityID) WHERE pupilsightMessengerTarget.type='Activity' AND (messageWall_date1=:date40 OR messageWall_date2=:date41 OR messageWall_date3=:date42) AND $sqlWhere AND staff='Y')";
            }
        }
    }
    if ($student) {
    ...
    if ($parent and $children != false) {
        ...
        if ($resultActivities->rowCount() > 0) {
            ...
            if ($sqlWhere != '(') {
                ...
                $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, category, image_240, concat('Activity: ', pupilsightActivity.name) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightActivity ON (pupilsightMessengerTarget.id=pupilsightActivity.pupilsightActivityID) WHERE pupilsightMessengerTarget.type='Activity' AND (messageWall_date1=:date46 OR messageWall_date2=:date47 OR messageWall_date3=:date48) AND $sqlWhere AND parents='Y')";
            }
        }
    }
    ...
    $sqlPosts = $sqlPosts." UNION (SELECT pupilsightMessenger.*, pupilsightPerson.title, pupilsightPerson.surname, pupilsightPerson.preferredName, category, pupilsightPerson.image_240, 'Individual: You' AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightPerson AS individual ON (pupilsightMessengerTarget.id=individual.pupilsightPersonID) WHERE pupilsightMessengerTarget.type='Individuals' AND (messageWall_date1=:date52 OR messageWall_date2=:date53 OR messageWall_date3=:date54) AND individual.pupilsightPersonID=:pupilsightPersonID4)";
    ...
    if ($parent and $children != false) {
        ...
        AND pupilsightMessengerTarget.type='Group' AND pupilsightMessengerTarget.parents='Y'
    ...
    if ($parent and $children != false) {
        ...
        AND pupilsightMessengerTarget.type='Transport' AND pupilsightMessengerTarget.parents='Y'
    ...
    if ($mode == 'result') {
        ...
        $resultReturn[1] = $sqlPosts.' ORDER BY subject, pupilsightMessengerID, source';

        return serialize($resultReturn);
    } else {
        $count = 0;
        try {
            $sqlPosts = $sqlPosts.' ORDER BY subject, pupilsightMessengerID, source';
