...
function getMessages1($guid, $connection2, $mode = '', $date = '', $fromdate = '', $msgcategory = '', $msgtype = '')
{
    ...
    if ($fromdate != $date) {
        ...
        if ($student) {
            ...
            $dataPosts['pupilsightSchoolYearID3'] = $_SESSION[$guid]['pupilsightSchoolYearID'];
            $dataPosts['pupilsightPersonID2'] = $_SESSION[$guid]['pupilsightPersonID'];
            $sqlPosts = $sqlPosts . " UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, pupilsightRole.category, image_240, concat('Roll Group: ', pupilsightRollGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightRollGroupID AND pupilsightMessengerTarget.pupilsightSchoolYearID=pupilsightStudentEnrolment.pupilsightSchoolYearID AND pupilsightMessengerTarget.pupilsightProgramID=pupilsightStudentEnrolment.pupilsightProgramID AND pupilsightMessengerTarget.pupilsightYearGroupID=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightRollGroup ON (pupilsightStudentEnrolment.pupilsightRollGroupID=pupilsightRollGroup.pupilsightRollGroupID) WHERE pupilsightStudentEnrolment.pupilsightPersonID=:pupilsightPersonID2 AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID3 AND pupilsightMessengerTarget.type='Roll Group' $msgcategory $msgtype AND ((messageWall_date1 BETWEEN '$fromdate' AND :date16) OR (messageWall_date2 BETWEEN '$fromdate' AND :date17) OR (messageWall_date3 BETWEEN '$fromdate' AND :date18)) AND students='Y' )";
        }
        if ($parent and $children != false) {
            $dataPosts['date19'] = $date;
            $dataPosts['date20'] = $date;
            $dataPosts['date21'] = $date;
            $dataPosts['pupilsightSchoolYearID4'] = $_SESSION[$guid]['pupilsightSchoolYearID'];
            $sqlPosts = $sqlPosts . " UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, pupilsightRole.category, image_240, concat('Roll Group: ', pupilsightRollGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightRollGroupID AND pupilsightMessengerTarget.pupilsightSchoolYearID=pupilsightStudentEnrolment.pupilsightSchoolYearID AND pupilsightMessengerTarget.pupilsightProgramID=pupilsightStudentEnrolment.pupilsightProgramID AND pupilsightMessengerTarget.pupilsightYearGroupID=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightRollGroup ON (pupilsightStudentEnrolment.pupilsightRollGroupID=pupilsightRollGroup.pupilsightRollGroupID) WHERE " . preg_replace('/pupilsightPersonID/', 'pupilsightStudentEnrolment.pupilsightPersonID', $children) . " AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID4 $msgcategory $msgtype AND pupilsightMessengerTarget.type='Roll Group' AND ((messageWall_date1 BETWEEN '$fromdate' AND :date19) OR (messageWall_date2 BETWEEN '$fromdate' AND :date20) OR (messageWall_date3 BETWEEN '$fromdate' AND :date21)) AND pupilsightMessengerTarget.parents='Y' )";
        }
        ...
        if ($student) {
            ...
            $dataPosts['pupilsightSchoolYearID3'] = $_SESSION[$guid]['pupilsightSchoolYearID'];
            $dataPosts['pupilsightPersonID2'] = $_SESSION[$guid]['pupilsightPersonID'];
            $sqlPosts = $sqlPosts . " UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, pupilsightRole.category, image_240, concat('Roll Group: ', pupilsightRollGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightRollGroupID AND pupilsightMessengerTarget.pupilsightSchoolYearID=pupilsightStudentEnrolment.pupilsightSchoolYearID AND pupilsightMessengerTarget.pupilsightProgramID=pupilsightStudentEnrolment.pupilsightProgramID AND pupilsightMessengerTarget.pupilsightYearGroupID=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightRollGroup ON (pupilsightStudentEnrolment.pupilsightRollGroupID=pupilsightRollGroup.pupilsightRollGroupID) WHERE pupilsightStudentEnrolment.pupilsightPersonID=:pupilsightPersonID2 $msgcategory $msgtype AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID3 AND pupilsightMessengerTarget.type='Roll Group' AND ((messageWall_date1 =:date16 OR messageWall_date2=:date17 OR messageWall_date3 =:date18)) AND students='Y')";
        }
        //echo $sqlPosts;
        if ($parent and $children != false) {
            $dataPosts['date19'] = $date;
            ...
            $dataPosts['date21'] = $date;
            $dataPosts['pupilsightSchoolYearID4'] = $_SESSION[$guid]['pupilsightSchoolYearID'];
            $sqlPosts = $sqlPosts . " UNION (SELECT pupilsightMessenger.*, title, surname, preferredName, pupilsightRole.category, image_240, concat('Roll Group: ', pupilsightRollGroup.nameShort) AS source FROM pupilsightMessenger JOIN pupilsightMessengerTarget ON (pupilsightMessengerTarget.pupilsightMessengerID=pupilsightMessenger.pupilsightMessengerID) JOIN pupilsightPerson ON (pupilsightMessenger.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) JOIN pupilsightRole ON (pupilsightPerson.pupilsightRoleIDPrimary=pupilsightRole.pupilsightRoleID) JOIN pupilsightStudentEnrolment ON (pupilsightMessengerTarget.id=pupilsightStudentEnrolment.pupilsightRollGroupID AND pupilsightMessengerTarget.pupilsightSchoolYearID=pupilsightStudentEnrolment.pupilsightSchoolYearID AND pupilsightMessengerTarget.pupilsightProgramID=pupilsightStudentEnrolment.pupilsightProgramID AND pupilsightMessengerTarget.pupilsightYearGroupID=pupilsightStudentEnrolment.pupilsightYearGroupID) JOIN pupilsightRollGroup ON (pupilsightStudentEnrolment.pupilsightRollGroupID=pupilsightRollGroup.pupilsightRollGroupID) WHERE " . preg_replace('/pupilsightPersonID/', 'pupilsightStudentEnrolment.pupilsightPersonID', $children) . " AND pupilsightStudentEnrolment.pupilsightSchoolYearID=:pupilsightSchoolYearID4 AND pupilsightMessengerTarget.type='Roll Group' $msgcategory $msgtype AND ((messageWall_date1 =:date19 OR messageWall_date2=:date20 OR messageWall_date3 =:date21)) AND pupilsightMessengerTarget.parents='Y')";
        }
...
function queryMembersreceipt($guid, $connection2, $mode = '', $msgtype = '', $fromdate = '', $todate = '')
{
    ...
    while ($row = $result->fetch()) {
        ...
        $output[$count]['targetType'] = $row['targetType'];
        $output[$count]['targetID'] = $row['targetID'];
        $output[$count]['contactType'] = $row['contactType'];
        $output[$count]['contactDetail'] = $row['contactDetail'];
