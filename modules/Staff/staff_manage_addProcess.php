...
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address']).'/staff_manage_add.php&search='.$_GET['search'];
        ...
        if ($result->rowCount() > 0) {
            ...
            if ($password != $passwordConfirm) {
                ...
                if ($passwordMatch == false) {
                    ...
                    try {
                        $sql = 'LOCK TABLES pupilsightPerson WRITE, pupilsightFileExtension WRITE, pupilsightStaff WRITE';
