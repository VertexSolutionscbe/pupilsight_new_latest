...
if (isActionAccessible($guid, $connection2, '/modules/Staff/jobOpenings_manage_delete.php') == false) {
    ...
    if ($pupilsightStaffJobOpeningID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/jobOpenings_manage_deleteProcess.php?pupilsightStaffJobOpeningID=$pupilsightStaffJobOpeningID");
            echo $form->getOutput();
        }
    }
}
