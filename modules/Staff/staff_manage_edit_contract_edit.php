...
if (isActionAccessible($guid, $connection2, '/modules/Staff/staff_manage_edit_contract_edit.php') == false) {
    ...
    if ($pupilsightStaffID == '' or $pupilsightStaffContractID == '') {
        echo "<div class='alert alert-danger'>";
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = Form::create('action', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/staff_manage_edit_contract_editProcess.php?pupilsightStaffContractID=$pupilsightStaffContractID&pupilsightStaffID=$pupilsightStaffID&search=$search");
