...
if (isActionAccessible($guid, $connection2, '/modules/Transport/transport_fee_assign_manage_edit.php') == false) {
    ...
    $page->breadcrumbs
        ...
        ->add(__('Edit Transport Fee Assign'));
    ...
    if ($id == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            echo '<h2>';
            echo __('Edit Transport Fee Assign');
            echo '</h2>';
            ...
            $form = Form::create('program', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/transport_fee_assign_manage_editProcess.php?id='.$id);
            $form->setFactory(DatabaseFormFactory::create($pdo));

            $form->addHiddenValue('address', $_SESSION[$guid]['address']);

            $form->addHiddenValue('schedule_id', $values['schedule_id']);
