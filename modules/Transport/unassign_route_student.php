...
$staff_id = $session->get('changeRoute_id');
...
//print_r($result->rowCount());die();
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/student_route_unassignProcess.php?id=$id", true);
            echo $form->getOutput();
        }
    }
}
