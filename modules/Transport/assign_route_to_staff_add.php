...
if (isActionAccessible($guid, $connection2, '/modules/Transport/assign_route_to_staff_add.php') == false) {
    ...
    $form = Form::create('frm_transport_assign_route', $_SESSION[$guid]['absoluteURL'] . '/modules/' . $_SESSION[$guid]['module'] . '/assign_route_to_staff_addprocess.php');
    ...
    $row->addFooter();
    //$row->addSubmit();
    $row->addContent('<button type="button" id="btn_transport_assign_route" class=" btn btn-primary" style="position:center; ">Submit</button>');
