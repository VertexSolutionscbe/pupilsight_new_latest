...
if (isActionAccessible($guid, $connection2, '/modules/Transport/assign_route_staff_add.php') == false) {
    //Acess denied
    ...
    $form = Form::create('program', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/assign_route_staff_addProcess.php');
