...
if (isActionAccessible($guid, $connection2, '/modules/Transport/change_staff_transportRoute_edit.php') != false) {
    //Acess denied
    ...
    if ($id == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $onwardroute_list1 = array (''=>'Select onward route');
        ...
        $form = Form::create('program', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/change_staff_transportRoute_editProcess.php');
        $form->setFactory(DatabaseFormFactory::create($pdo));
        $form->addHiddenValue('address', $_SESSION[$guid]['address']);
        $form->addHiddenValue('stu_id', $id);
        $row = $form->addRow();
