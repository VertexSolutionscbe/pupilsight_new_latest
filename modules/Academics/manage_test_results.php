...
if (isActionAccessible($guid, $connection2, '/modules/Academics/manage_test_results.php') == false) {
  ...
  /*  $tests =  array(__('Select') => array('Test1' => __('Test1'),
    ...
    echo "<a  id='lock_me_btn' data-type='lock' class='lock_me_btn btn btn-primary butt'>Lock Me</a>&nbsp;&nbsp;";  
    echo "<a  id='unlock_me_btn' data-type='unlock' class='lock_me_btn btn btn-primary butt'>Unlock Me</a>&nbsp;&nbsp;";
    echo "<a  id='publish_result' data-type='test' class='btn btn-primary butt'>Publish</a>&nbsp;&nbsp;";
    echo "<a  id='unpublish_result' data-type='test' class='btn btn-primary butt'>Unpublish</a>&nbsp;&nbsp;";
    echo "<a  id='withheld_result' data-type='test' class='btn btn-primary butt'>Withhold</a>&nbsp;&nbsp;";
