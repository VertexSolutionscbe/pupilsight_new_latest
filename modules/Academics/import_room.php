...
$URL = $_SESSION[$guid]['absoluteURL'] . '/index.php?q=/modules/Academics/examination_room_manage.php';
...
if (isActionAccessible($guid, $connection2, "/modules/Academics/examination_room_manage.php") == false) {
    ...
    $page->breadcrumbs->add(__('Manage Test Room'), 'examination_room_manage.php')
    ->add('Examination Room Import', '');
    $form = Form::create('importStep1', $_SESSION[$guid]['absoluteURL'] . '/index.php?q=/modules/' . $_SESSION[$guid]['module'] . '/import_room.php');
        ...
        if (!empty($all_rows)) {
            ...
            try {
                ...
                foreach ($all_rows as  $alrow) {
                    try {
                        // Staff Entry
                        $sql = "INSERT INTO examinationRoomMaster (";
