...
if (isActionAccessible($guid, $connection2, '/modules/Academics/grade_system_configure_delete.php') == false) {
    ...
    if ($id == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/grade_system_configure_deleteProcess.php?id=$id&sid=$gradeSystemId", true);
            echo $form->getOutput();
        }
    }
}
