...
if (isActionAccessible($guid, $connection2, '/modules/Academics/entry_marks_byStudent.php') == false) {
    ...
    LEFT JOIN history_of_subject_marks as smarks
    ON p.pupilsightPersonID = smarks.pupilsightPersonIDTaker
    WHERE smarks.test_id= "'.$tid.'" AND smarks.pupilsightPersonID="'.$stid.'" AND smarks.pupilsightDepartmentID="'.$skil_id.'" ORDER BY smarks.id DESC';
