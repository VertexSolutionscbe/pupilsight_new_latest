...
if (isActionAccessible($guid, $connection2, '/modules/Academics/test_marks_upload.php') == false) {
    ...
    echo "<a  id='upload_template_test' data-type='test'  class='btn btn-primary'  href='index.php?q=/modules/Academics/import_marks.php'>Upload/Import Marks</a>&nbsp;&nbsp;";
    ...
    if (isset($pupilsightProgramID)) {
        ...
        $col->addSelect('pupilsightProgramID')->fromArray($program)->required()->placeholder('Select Program')->setID('pupilsightProgramIDInUpload');
    }
...
<script type="text/javascript">
    ...
    function load_test() {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {
                pupilsightRollGroupID: favorite,
                pupilsightProgramID: pupilsightProgramID,
