...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/user_manage_delete.php') == false) {
    ...
    if ($pupilsightFirstAidID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/firstAidRecord_deleteProcess.php?pupilsightFirstAidID=$pupilsightFirstAidID", true);
            echo $form->getOutput();
        }
    }
}
