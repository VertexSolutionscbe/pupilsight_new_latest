...
if (isActionAccessible($guid, $connection2, '/modules/Students/student_view.php') == false) {
    ...
    //Get action with highest precendence
        ...
        $pupilsightPersonID = $_SESSION[$guid]['pupilsightPersonID'];
            ...
            echo "<a style='' id='restoreBulkStudent' class='btn btn-primary'>Bulk Restore</a>";
            ...
            $students = $studentGateway->getAllDeletedStudents($criteria, $pupilsightSchoolYearID, $canViewFullProfile, $pupilsightProgramID, $pupilsightYearGroupID, $pupilsightRollGroupID, $search);
...
<script>
    ...
    $(document).on('click', '#restoreBulkStudent', function() {
        var favorite = [];
            ...
            if (val != '') {
                $.ajax({
                    ...
                    success: function(response) {
                        alert('Student Restore Successfully!');
                        location.reload();
                    }
                });
            }
