...
$redirectURL =  $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address']).'/student_view.php';

$redirectURLNew = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address']).'/parent2_add.php&search='.$_GET['search'];
            ...
            if ($password != $passwordConfirm) {
                ...
                if ($passwordMatch == false) {
                    ...
                    try {
                        ...
                        $customField->postCustomField($_POST["custom"], 'pupilsightPersonID', $parentId);
                    ...
                    if ($imageFail) {
                        ...
                        $redirectURLNew .= "&return=success0&studentid=$insertstudentId";
                        header("Location: {$redirectURLNew}");
                    }
                }
            }
        }
