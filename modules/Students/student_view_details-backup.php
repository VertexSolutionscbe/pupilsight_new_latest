        ...
        if (empty($pupilsightPersonID)) {
            ...
            if (isActionAccessible($guid, $connection2, '/modules/Students/student_view_details.php', 'View Student Profile_brief') and $skipBrief == false) {
                ...
                if ($result->rowCount() != 1) {
                    ...
                    echo '</td>';
                    echo "<td style='width: 34%; vertical-align: top'>";
                    echo "<span class='form-label'>".__('House').'</span><br/>';
                    try {
                    ...
                    echo '</td>';
                    echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                    echo "<span class='form-label'>".__('Student ID').'</span><br/>';
                    if ($row['studentID'] != '') {
                        ...
                        if ($resultFamily->rowCount() < 1) {
                            ...
                            while ($rowFamily = $resultFamily->fetch()) {
                                ...
                                while ($rowMember = $resultMember->fetch()) {
                                    ...
                                    echo "<span class='form-label'>".__('Contact By Phone').'</span><br/>';
                                    ...
                                    echo "<span class='form-label'>".__('Contact By Email').'</span><br/>';
                ...
                if ($result->rowCount() != 1) {
                    ...
                    if ($subpage == 'Overview') {
                        ...
                        echo '</td>';
                        echo "<td style='width: 34%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Name In Characters').'</span><br/>';
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Username').'</span><br/>';
                        echo $row['username'];
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Age').'</span><br/>';
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('School History').'</span><br/>';
                        if ($row['dateStart'] != '') {
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Locker Number').'</span><br/>';
                        if ($row['lockerNumber'] != '') {
                        ...
                        if ($privacySetting == 'Y') {
                            ...
                            echo "<span class='form-label'>".__('Privacy').'</span><br/>';
                            if ($row['privacy'] != '') {
                        ...
                        if ($studentAgreementOptions != '') {
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top' colspan=3>";
                            echo "<span class='form-label'>".__('Student Agreements').'</span><br/>';
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('First Name').'</span><br/>';
                        echo $row['firstName'];
                        echo '</td>';
                        echo "<td style='width: 34%; vertical-align: top'>";
                        ...
                        if ($row['phone1'] != '' or $row['phone2'] != '' or $row['phone3'] != '' or $row['phone4'] != '') {
                            ...
                            for ($i = 1; $i < 5; ++$i) {
                                if ($row['phone'.$i] != '') {
                                    ...
                                    echo "<span class='form-label'>".__('Phone')." $numberCount</span><br/>";
                                    if ($row['phone'.$i.'Type'] != '') {
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Alternate Email').'</span><br/>';
                        ...
                        if ($row['address1'] != '') {
                            ...
                            echo "<span class='form-label'>".__('Address 1').'</span><br/>';
                        ...
                        if ($row['address2'] != '') {
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top' colspan=3>";
                            echo "<span class='form-label'>".__('Address 2').'</span><br/>';
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Last School').'</span><br/>';
                        echo $row['lastSchool'];
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Class Of').'</span><br/>';
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Next School').'</span><br/>';
                        echo $row['nextSchool'];
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Departure Reason').'</span><br/>';
                        ...
                        if ($dayTypeOptions != '') {
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            echo "<span class='form-label'>".__('Day Type').'</span><br/>';
                            echo $row['dayType'];
                            echo '</td>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Ethnicity').'</span><br/>';
                        echo $row['ethnicity'];
                        echo '</td>';
                        echo "<td style='width: 34%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Religion').'</span><br/>';
                        echo $row['religion'];
                        echo '</td>';
                        echo '</tr>';
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Citizenship 1').'</span><br/>';
                        if ($row['citizenship1'] != '')
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Citizenship 2').'</span><br/>';
                        ...
                        if ($_SESSION[$guid]['country'] == '') {
                            echo "<span class='form-label'>".__('National ID Card').'</span><br/>';
                        } else {
                            echo "<span class='form-label'>".$_SESSION[$guid]['country'].' '.__('ID Card').'</span><br/>';
                        }
                        ...
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        if ($_SESSION[$guid]['country'] == '') {
                            echo "<span class='form-label'>".__('Residency/Visa Type').'</span><br/>';
                        } else {
                            echo "<span class='form-label'>".$_SESSION[$guid]['country'].' '.__('Residency/Visa Type').'</span><br/>';
                        }
                        echo $row['residencyStatus'];
                        echo '</td>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        if ($_SESSION[$guid]['country'] == '') {
                            echo "<span class='form-label'>".__('Visa Expiry Date').'</span><br/>';
                        } else {
                            echo "<span class='form-label'>".$_SESSION[$guid]['country'].' '.__('Visa Expiry Date').'</span><br/>';
                        }
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Can Login?').'</span><br/>';
                        echo ynExpander($guid, $row['canLogin']);
                        echo '</td>';
                        echo "<td style='width: 34%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Last IP Address').'</span><br/>';
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Transport').'</span><br/>';
                        echo $row['transport'];
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Vehicle Registration').'</span><br/>';
                        ...
                        if ($privacySetting == 'Y') {
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top' colspan=3>";
                            echo "<span class='form-label'>".__('Image Privacy').'</span><br/>';
                            if ($row['privacy'] != '') {
                                echo "<span style='color: #cc0000; background-color: #F6CECB'>";
                                echo __('Privacy required:').' '.$row['privacy'];
                                echo '</span>';
                        ...
                        if ($resultFields->rowCount() > 0) {
                            ...
                            while ($rowFields = $resultFields->fetch()) {
                                ...
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__($rowFields['name']).'</span><br/>';
                        ...
                        if ($resultFamily->rowCount() < 1) {
                            ...
                            while ($rowFamily = $resultFamily->fetch()) {
                                ...
                                if (isActionAccessible($guid, $connection2, '/modules/User Admin/family_manage.php') == true) {
                                    echo "<div class='linkTop'>";
                                    echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/User Admin/family_manage_edit.php&pupilsightFamilyID='.$rowFamily['pupilsightFamilyID']."'><i style='margin: 0 0 -4px 5px' title='".__('Edit')."' class='mdi mdi-pencil-box-outline mdi-24px px-2'></i></a> ";
                                    echo '</div>';
                                }
                                ...
                                echo '<tr>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Address Name').'</span><br/>';
                                ...
                                echo '</td>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Home Address (District)').'</span><br/>';
                                echo $rowFamily['homeAddressDistrict'];
                                echo '</td>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Home Address (Country)').'</span><br/>';
                                ...
                                while ($rowMember = $resultMember->fetch()) {
                                    ...
                                    echo "<span class='form-label'>".__('Contact Priority').'</span><br/>';
                                    ...
                                    echo '</td>';
                                    echo "<td $class style='width: 33%; padding-top: 15px; width: 33%; vertical-align: top'>";
                                    echo "<span class='form-label'>".__('Contact By SMS').'</span><br/>';
                                    ...
                                    echo '<tr>';
                                    echo "<td $class style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                    echo "<span class='form-label'>".__('Profession').'</span><br/>';
                                    echo $rowMember['profession'];
                                    echo '</td>';
                                    echo "<td $class style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                    echo "<span class='form-label'>".__('Employer').'</span><br/>';
                                    echo $rowMember['employer'];
                                    echo '</td>';
                                    echo "<td $class style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                    echo "<span class='form-label'>".__('Job Title').'</span><br/>';
                                    ...
                                    if ($rowMember['comment'] != '') {
                                        ...
                                        echo "<span class='form-label'>".__('Comment').'</span><br/>';
                                ...
                                if ($resultMember->rowCount() > 0) {
                                    ...
                                    while ($rowMember = $resultMember->fetch()) {
                                        ...
                                        if ($rowMember['status'] == 'Full') {
                                            echo "<a href='index.php?q=/modules/Students/student_view_details.php&pupilsightPersonID=".$rowMember['pupilsightPersonID'].$allStudents."'>".Format::name('', $rowMember['preferredName'], $rowMember['surname'], 'Student').'</a><br/>';
                                        } else {
                        ...
                        if ($resultFamily->rowCount() != 1) {
                            ...
                            while ($rowMember = $resultMember->fetch()) {
                                ...
                                echo '</td>';
                                echo "<td style='width: 33%; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Relationship').'</span><br/>';
                                try {
                                    $dataRelationship = array('pupilsightPersonID1' => $rowMember['pupilsightPersonID'], 'pupilsightPersonID2' => $pupilsightPersonID, 'pupilsightFamilyID' => $rowFamily['pupilsightFamilyID']);
                                    $sqlRelationship = 'SELECT * FROM pupilsightFamilyRelationship WHERE pupilsightPersonID1=:pupilsightPersonID1 AND pupilsightPersonID2=:pupilsightPersonID2 AND pupilsightFamilyID=:pupilsightFamilyID';
                                    $resultRelationship = $connection2->prepare($sqlRelationship);
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Contact 1').'</span><br/>';
                        ...
                        echo '</td>';
                        echo "<td style='width: 33%; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Number 1').'</span><br/>';
                        echo $row['emergency1Number1'];
                        echo '</td>';
                        echo "<td style=width: 34%; 'vertical-align: top'>";
                        echo "<span class='form-label'>".__('Number 2').'</span><br/>';
                        if ($row['website'] != '') {
                        ...
                        echo '<tr>';
                        echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                        echo "<span class='form-label'>".__('Contact 2').'</span><br/>';
                        ...
                        if ($resultMedical->rowCount() != 1) {
                            if (isActionAccessible($guid, $connection2, '/modules/Students/medicalForm_manage_add.php') == true) {
                                echo "<div class='linkTop'>";
                                echo "<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Students/medicalForm_manage_add.php&pupilsightPersonID=$pupilsightPersonID&search='>Add Medical Form<img style='margin: 0 0 -4px 3px' title='Add Medical Form' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/page_new.png'/></a> ";
                                echo '</div>';
                            }
                            ...
                            if (isActionAccessible($guid, $connection2, '/modules/User Admin/medicalForm_manage.php') == true) {
                                echo "<div class='linkTop'>";
                                echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/User Admin/medicalForm_manage_edit.php&pupilsightPersonMedicalID='.$rowMedical['pupilsightPersonMedicalID']."'><i style='margin: 0 0 -4px 5px' title='".__('Edit')."' class='mdi mdi-pencil-box-outline mdi-24px px-2'></i></a> ";
                                echo '</div>';
                            }
                            ...
                            echo '<tr>';
                            echo "<td style='width: 33%; vertical-align: top'>";
                            echo "<span class='form-label'>".__('Long Term Medication').'</span><br/>';
                            ...
                            echo "<span class='form-label'>".__('Details').'</span><br/>';
                            echo $rowMedical['longTermMedicationDetails'];
                            echo '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            echo "<span class='form-label'>".__('Tetanus Last 10 Years?').'</span><br/>';
                            ...
                            echo '</td>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            echo "<span class='form-label'>".__('Blood Type').'</span><br/>';
                            echo $rowMedical['bloodType'];
                            echo '</td>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            echo "<span class='form-label'>".__('Medical Conditions?').'</span><br/>';
                            ...
                            while ($rowCondition = $resultCondition->fetch()) {
                                ...
                                echo "<span class='form-label'>".__('Triggers').'</span><br/>';
                                echo $rowCondition['triggers'];
                                echo '</td>';
                                echo "<td style='width: 50%; vertical-align: top' colspan=2>";
                                echo "<span class='form-label'>".__('Reaction').'</span><br/>';
                                echo $rowCondition['reaction'];
                                echo '</td>';
                                echo '</tr>';
                                echo '<tr>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Response').'</span><br/>';
                                echo $rowCondition['response'];
                                echo '</td>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Medication').'</span><br/>';
                                echo $rowCondition['medication'];
                                echo '</td>';
                                echo '</tr>';
                                echo '<tr>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Last Episode Date').'</span><br/>';
                                if (is_null($row['dob']) == false and $row['dob'] != '0000-00-00') {
                                    echo dateConvertBack($guid, $rowCondition['lastEpisode']);
                                }
                                echo '</td>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                                echo "<span class='form-label'>".__('Last Episode Treatment').'</span><br/>';
                                echo $rowCondition['lastEpisodeTreatment'];
                                echo '</td>';
                                echo '</tr>';
                                echo '<tr>';
                                echo "<td style='width: 33%; padding-top: 15px; vertical-align: top' colspan=2>";
                                echo "<span class='form-label'>".__('Comments').'</span><br/>';
                            ...
                            if (isActionAccessible($guid, $connection2, '/modules/Students/student_view_details_notes_add.php') == false) {
                                ...
                                if ($result->rowCount() < 1) {
                                    ...
                                    while ($row = $result->fetch()) {
                                        ...
                                        echo '});';
                                        echo '</script>';
                                        echo "<a title='".__('View Description')."' class='show_hide-$count' onclick='return false;' href='#'><img title='".__('View Details')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/page_down.png'/></a></span><br/>";
                                        echo '</td>';
                                        echo '</tr>';
                        ...
                        if (isActionAccessible($guid, $connection2, '/modules/Individual Needs/in_view.php') == false) {
                            ...
                            if (isActionAccessible($guid, $connection2, '/modules/Individual Needs/in_edit.php') == true) {
                                echo "<div class='linkTop'>";
                                echo "<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Individual Needs/in_edit.php&pupilsightPersonID=$pupilsightPersonID'><i style='margin: 0 0 -4px 5px' title='".__('Edit')."' class='mdi mdi-pencil-box-outline mdi-24px px-2'></i></a> ";
                                echo '</div>';
                            }
                        ...
                        if (!(isActionAccessible($guid, $connection2, '/modules/Planner/planner_edit.php') or isActionAccessible($guid, $connection2, '/modules/Planner/planner_view_full.php'))) {
                            ...
                            if ($resultDeadlines->rowCount() < 1) {
                                ...
                                while ($rowDeadlines = $resultDeadlines->fetch()) {
                                    ...
                                    echo "<li $style>";
                                    echo "<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Planner/planner_view_full.php&search=$pupilsightPersonID&pupilsightPlannerEntryID=".$rowDeadlines['pupilsightPlannerEntryID'].'&viewBy=date&date='.$rowDeadlines['date']."&width=1000&height=550'>".$rowDeadlines['course'].'.'.$rowDeadlines['class'].'</a><br/>';
                    ...
                    $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Overview'>".__('Overview').'</a></li>';
                    $style = '';
                    if ($subpage == 'Personal') {
                        $style = "style='font-weight: bold'";
                    }
                    $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Personal'>".__('Personal').'</a></li>';
                    $style = '';
                    if ($subpage == 'Family') {
                        $style = "style='font-weight: bold'";
                    }
                    $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Family'>".__('Family').'</a></li>';
                    $style = '';
                    if ($subpage == 'Emergency Contacts') {
                        $style = "style='font-weight: bold'";
                    }
                    $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Emergency Contacts'>".__('Emergency Contacts').'</a></li>';
                    $style = '';
                    if ($subpage == 'Medical') {
                        $style = "style='font-weight: bold'";
                    }
                    $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Medical'>".__('Medical').'</a></li>';
                    if (isActionAccessible($guid, $connection2, '/modules/Students/student_view_details_notes_add.php')) {
                        if ($enableStudentNotes == 'Y') {
                            ...
                            $_SESSION[$guid]['sidebarExtra'] .= "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Notes'>".__('Notes').'</a></li>';
                        }
                    }
                    ...
                    if (isActionAccessible($guid, $connection2, '/modules/Markbook/markbook_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Markbook'>".__('Markbook').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Formal Assessment/internalAssessment_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Internal%20Assessment'>".__('Internal Assessment').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Formal Assessment/externalAssessment_details.php') or isActionAccessible($guid, $connection2, '/modules/Formal Assessment/externalAssessment_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=External Assessment'>".__('External Assessment').'</a></li>';
                        ++$studentMenuCount;
                    }
                    ...
                    if (isActionAccessible($guid, $connection2, '/modules/Activities/report_activityChoices_byStudent.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Activities'>".__('Activities').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Planner/planner_edit.php') or isActionAccessible($guid, $connection2, '/modules/Planner/planner_view_full.php')) {
                        $style = '';
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Homework'>".__('Homework').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Individual Needs/in_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Individual Needs'>".__('Individual Needs').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Library/report_studentBorrowingRecord.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Library Borrowing'>".__('Library Borrowing').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Timetable/tt_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Timetable'>".__('Timetable').'</a></li>';
                        ++$studentMenuCount;
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Attendance'>".__('Attendance').'</a></li>';
                        ++$studentMenuCount;
                    }
                    if (isActionAccessible($guid, $connection2, '/modules/Behaviour/behaviour_view.php')) {
                        ...
                        $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search."&search=$search&allStudents=$allStudents&subpage=Behaviour'>".__('Behaviour').'</a></li>';
                        ++$studentMenuCount;
                    }
                    ...
                    if ($resultHooks->rowCount() > 0) {
                        ...
                        while ($rowHooks = $resultHooks->fetch()) {
                            ...
                            if ($resultHook->rowCount() == 1) {
                                ...
                                $studentMenuLink[$studentMenuCount] = "<li><a $style href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q='.$_GET['q']."&pupilsightPersonID=$pupilsightPersonID&search=".$search.'&hook='.$rowHooks['name'].'&module='.$options['sourceModuleName'].'&action='.$options['sourceModuleAction'].'&pupilsightHookID='.$rowHooks['pupilsightHookID']."'>".__($rowHooks['name']).'</a></li>';
                                ++$studentMenuCount;
                                ++$count;
                            }
                        }
