...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/issues_view.php") == FALSE || !(isPersonsIssue($connection2, $_GET["issueID"], $_SESSION[$guid]["pupilsightPersonID"]) || getPermissionValue($connection2, $_SESSION[$guid]["pupilsightPersonID"], "fullAccess"))) {
	//Acess denied
