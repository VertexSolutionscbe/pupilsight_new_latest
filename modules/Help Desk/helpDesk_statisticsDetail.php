...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/helpDesk_manageTechnicians.php") == FALSE) {
    ...
    $result = getLog($connection2, $_SESSION[$guid]["pupilsightSchoolYearID"], getModuleIDFromName($connection2, "Help Desk"), null, $title, $startDate, $endDate, null, null);
        ...
        if (!$result->rowcount() == 0){
            ...
            while ($row = $result->fetch()){
                ...
                print "<tr class='$class'>";
                    ...
                    print "</td>";
                    print "<td>";
                        $row2 = getPersonName($connection2, $row['pupilsightPersonID']);
