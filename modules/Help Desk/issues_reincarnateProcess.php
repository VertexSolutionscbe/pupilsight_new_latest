...
$allowed = isPersonsIssue($connection2, $issueID, $_SESSION[$guid]["pupilsightPersonID"]) || (relatedToIssue($connection2, $issueID, $_SESSION[$guid]["pupilsightPersonID"]) && getPermissionValue($connection2, $_SESSION[$guid]["pupilsightPersonID"], "reincarnateIssue"));
...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/issues_view.php") == FALSE || !$allowed) {
	...
	setLog($connection2, $_SESSION[$guid]["pupilsightSchoolYearID"], $pupilsightModuleID, $_SESSION[$guid]["pupilsightPersonID"], "Issue Reincarnated", $array, null);
