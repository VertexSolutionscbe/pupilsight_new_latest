...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/helpDesk_manageTechnicians.php") == FALSE) {
    ...
    if ($person == "" || $group == "") {
        ...
        try {
            ...
            $data = array("pupilsightPersonID" => $person, "groupID" => $group);
            $sql = "INSERT INTO helpDeskTechnicians SET pupilsightPersonID = :pupilsightPersonID, groupID = :groupID" ;
        ...
        setLog($connection2, $_SESSION[$guid]["pupilsightSchoolYearID"], $pupilsightModuleID, $_SESSION[$guid]["pupilsightPersonID"], "Technician Added", array("pupilsightPersonID"=>$person, "technicianID"=>$technicianID), null);
