...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/helpDesk_manageTechnicianGroup.php")==FALSE) {
    ...
    try {
        ...
        $sql2="SELECT * FROM helpDeskTechnicians JOIN pupilsightPerson ON (helpDeskTechnicians.pupilsightPersonID=pupilsightPerson.pupilsightPersonID)" . $whereGroup;
    ...
    print "<div class='linkTop'>" ;
        print "<a style='position:relative; bottom:5px;float:right;' href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/helpDesk_createTechnicianGroup.php'><img style='margin-left: 2px' title=" . __($guid, 'Create ') . "' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["pupilsightThemeName"] . "/img/page_new.png'/></a>";
        ...
        if (!$result->rowcount() == 0) {
            ...
            while ($row = $result->fetch()) {
                ...
                print "<tr class='$class'>";
                    ...
                    print "</td>";
                    print "<td>";
                        print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/helpDesk_editTechnicianGroup.php&groupID=". $row['groupID'] ."'><img title=" . __($guid, 'Edit ') . "' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["pupilsightThemeName"] . "/img/config.png'/></a>";
                        if($result->rowcount() > 1) { print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/helpDesk_technicianGroupDelete.php&groupID=". $row['groupID'] ."'><img title=" . __($guid, 'Delete Technician Group ') . "' src='" . $_SESSION[$guid]["absoluteURL"] . "/themes/" . $_SESSION[$guid]["pupilsightThemeName"] . "/img/garbage.png'/></a>"; }
                    print"</td>" ;
                print "</tr>" ;
                $rowCount++;
            }
