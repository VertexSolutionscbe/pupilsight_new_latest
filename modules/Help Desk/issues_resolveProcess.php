...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/issues_view.php") == FALSE || !getPermissionValue($connection2, $_SESSION[$guid]["pupilsightPersonID"], "resolveIssue")) {
	//Fail 0
	...
	if ($issueID == "") {
		...
		if (relatedToIssue($connection2, $issueID, $_SESSION[$guid]["pupilsightPersonID"]) || getPermissionValue($connection2, $_SESSION[$guid]["pupilsightPersonID"], "resolveIssue")) {
			//Write to database
			try {
			...
			setLog($connection2, $_SESSION[$guid]["pupilsightSchoolYearID"], $pupilsightModuleID, $_SESSION[$guid]["pupilsightPersonID"], "Issue Resolved", $array, null);
