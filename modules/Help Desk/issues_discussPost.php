...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/issues_view.php") == FALSE || !relatedToIssue($connection2, $_GET["issueID"], $_SESSION[$guid]["pupilsightPersonID"])) {
    //Acess denied
