...
if (isActionAccessible($guid, $connection2, "/modules/Help Desk/issues_view.php") == FALSE || !getPermissionValue($connection2, $_SESSION[$guid]["pupilsightPersonID"], $permission)) {
	//Fail 0
	...
	setLog($connection2, $_SESSION[$guid]["pupilsightSchoolYearID"], $pupilsightModuleID, $_SESSION[$guid]["pupilsightPersonID"], "Technician Assigned", array("issueID" => $issueID, "technicainID"=>$technicianID), null);
