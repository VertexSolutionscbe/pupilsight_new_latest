 ...
 * Basic variables
 */
$name        = "Admission";            // The name of the variable as it appears to users. Needs to be unique to installation. Also the name of the folder that holds the unit.
$description = "Admission Module";            // Short text description
$entryURL    = "index.php";   // The landing page for the unit, used in the main menu
$type        = "Additional";  // Do not change.
$category    = "Admission";            // The main menu area to place the module in
$version     = "18.0.00";            // Version number
$author      = "";            // Your name
$url         = "http://www.pupilsight.in";            // Your URL
 ...
 */
$actionRows[] = [
    'name'         => "Admission",   // The name of the action (appears to user in the right hand side module menu)
    'precedence'   => "0",  // If it is a grouped action, the precedence controls which is highest action in group
    'category'     => "education",   // Optional: subgroups for the right hand side module menu
