     ...
     <div class="modal-dialog modal-lg" style="max-width:1250px !important;">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <iframe id="wppage" src="<?php echo $_SESSION[$guid]['absoluteURL']; ?>/wp/wp-admin/admin.php?page=fluent_forms&route=entries&form_id=<?php echo $formId; ?>#/entries/<?php echo $subId; ?>" style="width:100%;height:85vh;border:0;"></iframe>
             </div>
         </div>
     </div>
 </div>
