  ...
  <div class="modal-dialog modal-lg" style="max-width:1250px !important;">
    ...
    <div class="modal-body">
     <!-- <iframe src="http://wp.pupiltalk.com/wp-admin/admin.php?page=fluent_forms#add=1" style="width:100%;height:93vh"></iframe>-->
        ...
        <iframe id="wppage" src="<?php echo $_SESSION[$guid]['absoluteURL'];?>/wp/wp-admin/admin.php?page=fluent_forms&route=entries&form_id=<?php echo $formId;?>#/entries/<?php echo $subId;?>" style="width:100%;height:93vh"></iframe>
    </div>     
    </div>
  </div>
</div>
