<?php
    ...
    $_SESSION["callbackurl"] = $_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Campaign/offline_fluent.php";
?>
<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'];?>/wp/wp-login.php?admin=formaccess" id="loginform" name="loginform" style="display:none">
    ...
    --->
        ...
        <input type="hidden" value="<?php echo $_SESSION[$guid]['absoluteURL'];?>'/index.php?q=/modules/Campaign/offline_fluent.php" name="redirect_to">
