...
$id = $_GET['id'];
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address']).'/campaign_series_manage.php';
        ...
        if ($result->rowCount() != 1) {
            ...
            if ($series_name == ''  or $format == '' ) {
                ...
                if ($result->rowCount() > 0) {
                    ...
                    //Write to database
                    try {
                        $data = array('type' => $type, 'series_name' => $series_name, 'pupilsightSchoolYearID' => $pupilsightSchoolYearID, 'format' => $format, 'description' => $description, 'start_number' => $start_number, 'no_of_digit' => $no_of_digit, 'start_char' => $start_char, 'id' => $id);
