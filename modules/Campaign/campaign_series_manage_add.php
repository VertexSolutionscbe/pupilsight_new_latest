...
if (isActionAccessible($guid, $connection2, '/modules/Campaign/campaign_series_manage_add.php') == false) {
    //Acess denied
    ...
    //Proceed!
    $page->breadcrumbs
        ->add(__('Manage Campaign Series'), 'campaign_series_manage.php')
        ->add(__('Add Campaign Series'));

    $editLink = '';
    if (isset($_GET['editID'])) {
        $editLink = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/Campaign/campaign_series_manage_edit.php&id='.$_GET['editID'];
    }
    ...
    $form = Form::create('feeseries', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/campaign_series_manage_addProcess.php');
    ...
    $seriestype = array(''=>'Select Type', 'Admission' => 'Admission', 'Application' => 'Application');
