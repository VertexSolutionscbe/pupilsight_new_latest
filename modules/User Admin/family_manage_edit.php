...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/family_manage_edit.php') == false) {
    ...
    if ($pupilsightFamilyID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = Form::create('action1', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/family_manage_editProcess.php?pupilsightFamilyID=$pupilsightFamilyID&search=$search");
            ...
            if ($resultChildren->rowCount() < 1 or $resultAdults->rowCount() < 1) {
                ...
                $form = Form::create('action2', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_relationshipsProcess.php?pupilsightFamilyID=$pupilsightFamilyID&search=$search");
            ...
            if ($resultChildren->rowCount() < 1) {
                ...
                foreach ($children as $child) {
                    ...
                    echo '</td>';
                    echo '<td>';
                    echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_editChild.php&pupilsightFamilyID=$pupilsightFamilyID&pupilsightPersonID=".$child['pupilsightPersonID']."&search=$search'><img title='".__('Edit')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/config.png'/></a> ";
                    ...
                    echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/user_manage_password.php&pupilsightPersonID='.$child['pupilsightPersonID']."&search=$search'><img title='".__('Change Password')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/key.png'/></a>";
                    echo '</td>';
                    echo '</tr>';
                }
                echo '</table>';
            ...
            $form = Form::create('action3', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_addChildProcess.php?pupilsightFamilyID=$pupilsightFamilyID&search=$search");
            $form->setFactory(DatabaseFormFactory::create($pdo));
            ...
            if ($resultAdults->rowCount() < 1) {
                ...
                foreach ($adults as $adult) {
                    ...
                    echo '</td>';
                    echo '<td>';
                    echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_editAdult.php&pupilsightFamilyID=$pupilsightFamilyID&pupilsightPersonID=".$adult['pupilsightPersonID']."&search=$search'><img title='".__('Edit')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/config.png'/></a> ";
                    echo "<a class='thickbox' href='".$_SESSION[$guid]['absoluteURL'].'/fullscreen.php?q=/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_deleteAdult.php&pupilsightFamilyID=$pupilsightFamilyID&pupilsightPersonID=".$adult['pupilsightPersonID']."&search=$search&width=650&height=135'><img title='".__('Delete')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/garbage.png'/></a>";
                    echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/user_manage_password.php&pupilsightPersonID='.$adult['pupilsightPersonID']."&search=$search'><img title='".__('Change Password')."' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/key.png'/></a>";
                    echo '</td>';
                    echo '</tr>';
                }
                echo '</table>';
            ...
            $form = Form::create('action4', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/family_manage_edit_addAdultProcess.php?pupilsightFamilyID=$pupilsightFamilyID&search=$search");
