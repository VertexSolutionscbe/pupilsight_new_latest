...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/user_manage_edit.php') == false) {
    ...
    if ($pupilsightPersonID == '') {
        ...
        if ($result->rowCount() != 1) {
			...
			$form = Form::create('addUser', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/user_manage_editProcess.php?pupilsightPersonID='.$pupilsightPersonID.'&search='.$search);
