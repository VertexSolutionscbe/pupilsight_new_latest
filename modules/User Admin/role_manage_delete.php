...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/role_manage_delete.php') == false) {
    ...
    if ($pupilsightRoleID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/role_manage_deleteProcess.php?pupilsightRoleID=$pupilsightRoleID", true);
            echo $form->getOutput();
        }
    }
}
