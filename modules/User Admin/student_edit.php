...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/student_edit.php') == false) {
    ...
    if ($pupilsightPersonID == '') {
        ...
        if ($result->rowCount() != 1) {
			...
			echo "<div style='height:50px;'><div class='float-left mb-2'><a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/User Admin/student_edit.php&pupilsightPersonID=".$pupilsightPersonID."&search=' class='btn btn-primary active'>Student</a>";  
			foreach($parents as $par){
				echo "&nbsp;&nbsp;<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/User Admin/parent_edit.php&pupilsightPersonID=".$par['pupilsightPersonID1']."&search=' class='btn btn-primary'>Parent</a>"; 
			}
			echo "&nbsp;&nbsp;<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/User Admin/family_manage_edit.php&pupilsightFamilyID=".$parents[0]['pupilsightFamilyID']."' class='btn btn-primary'>Family</a></div><div class='float-none'></div></div>"; 

			$form = Form::create('addUser', $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module'].'/student_editProcess.php?pupilsightPersonID='.$pupilsightPersonID.'&search='.$search);
