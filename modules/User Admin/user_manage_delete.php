...
if (isActionAccessible($guid, $connection2, '/modules/User Admin/user_manage_delete.php') == false) {
    ...
    if ($pupilsightPersonID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/user_manage_deleteProcess.php?pupilsightPersonID=$pupilsightPersonID&search=".$_GET['search'], true);
            echo $form->getOutput();
        }
    }
}
