            ...
            if ($result2->rowCount() != 1) {
                ...
                if ($result3->rowCount() != 1) {
                    ...
                    if ($result4->rowCount() != 1) {
                        ...
                        echo rubricView($guid, $connection2, $pupilsightRubricID, false, $row4['pupilsightPersonID'], 'atlColumn', 'atlColumnID', $atlColumnID,  $contextDBTablePupilsightRubricIDField, 'name', 'completeDate');
                    }
                }
            }
        }
