...
if (isActionAccessible($guid, $connection2, '/modules/Activities/activities_view_old.php') == false) {
    //Acess denied
    ...
    if ($highestAction == false) {
        ...
        if (!($access == 'View' or $access == 'Register')) {
            ...
            $form->addHiddenValue('q', "/modules/".$_SESSION[$guid]['module']."/activities_view_old.php");
