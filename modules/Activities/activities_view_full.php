            ...
            //Check existence of and access to this class.
                ...
                try {
                    if ($dateType != 'Date') {
                        ...
                        $sql = "SELECT * FROM pupilsightActivity WHERE pupilsightSchoolYearID=:pupilsightSchoolYearID AND active='Y' AND NOT pupilsightSchoolYearTermIDList='' AND pupilsightActivityID=:pupilsightActivityID";
                    } else {
                        ...
                        $sql = "SELECT * FROM pupilsightActivity WHERE pupilsightSchoolYearID=:pupilsightSchoolYearID AND active='Y' AND listingStart<=:listingStart AND listingEnd>=:listingEnd AND pupilsightActivityID=:pupilsightActivityID";
                    }
                ...
                if ($result->rowCount() != 1) {
                    ...
                    if ($hideExternalProviderCost == 'Y' and $row['provider'] == 'External') {
                        echo "<span class='form-label'>".__('Cost').'</span><br/>';
                    ...
                    try {
                        ...
                        $sqlStaff = "SELECT title, preferredName, surname, role FROM pupilsightActivityStaff JOIN pupilsightPerson ON (pupilsightActivityStaff.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) WHERE pupilsightActivityID=:pupilsightActivityID AND pupilsightPerson.status='Full' ORDER BY surname, preferredName";
