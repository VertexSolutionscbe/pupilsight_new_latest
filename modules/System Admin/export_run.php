    ...
    foreach ($importType->getTables() as $index => $tableName) {
        ...
        if ($dataExport) {
            ...
            if ($dataExportAll == false) {
                ...
                $pupilsightSchoolYearID = $importType->getField('pupilsightSchoolYearID', 'name', null);
                
                if ($pupilsightSchoolYearID != null && $importType->isFieldReadOnly('pupilsightSchoolYearID') == false) {
                    $data['pupilsightSchoolYearID'] = $_SESSION[$guid]['pupilsightSchoolYearID'];
                    $sql .= " WHERE pupilsightSchoolYearID=:pupilsightSchoolYearID ";
                }
            }
