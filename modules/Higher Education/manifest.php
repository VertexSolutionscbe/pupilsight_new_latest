...
$moduleTables[4] = "CREATE TABLE `higherEducationStaff` (`higherEducationStaffID` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT, `pupilsightPersonID` int(10) unsigned zerofill NOT NULL, `role` enum('Coordinator','Advisor') NOT NULL, PRIMARY KEY (`higherEducationStaffID`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;";
$moduleTables[5] = 'CREATE TABLE `higherEducationStudent` (  `higherEducationStudentID` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,  `pupilsightPersonID` int(10) unsigned zerofill NOT NULL,  `pupilsightPersonIDAdvisor` int(10) unsigned zerofill DEFAULT NULL,  `referenceNotes` text NOT NULL,  PRIMARY KEY (`higherEducationStudentID`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;';
$moduleTables[6] = "CREATE TABLE `higherEducationApplication` ( `higherEducationApplicationID` int(8) unsigned zerofill NOT NULL auto_increment, `pupilsightPersonID` int(10) unsigned zerofill NOT NULL, `applying` enum('Y','N') NOT NULL default 'Y', `otherScores` text, `careerInterests` text, `coursesMajors` text, `personalStatement` text NOT NULL, `meetingNotes` text NOT NULL, PRIMARY KEY  (`higherEducationApplicationID`), UNIQUE KEY `pupilsightPersonID` (`pupilsightPersonID`)) ENGINE=InnoDB ;";
