    ...
    if ($role != 'Coordinator') {
        ...
        if ($higherEducationReferenceID == '' or $pupilsightSchoolYearID == '') {
            ...
            try {
                ...
                $sql = "SELECT preferredName, surname, higherEducationReference.* FROM higherEducationReference JOIN pupilsightPerson ON (higherEducationReference.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) WHERE higherEducationReferenceID=:higherEducationReferenceID AND pupilsightPerson.status='Full'";
            ...
            if ($result->rowCount() != 1) {
                ...
                echo "<a target='_blank' href='".$_SESSION[$guid]['absoluteURL'].'/report.php?q=/modules/'.$_SESSION[$guid]['module']."/references_manage_edit_print.php&higherEducationReferenceID=$higherEducationReferenceID'><img title='Print' src='./themes/".$_SESSION[$guid]['pupilsightThemeName']."/img/print.png'/></a>";
                echo '</div>'; ?>

                <form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/references_manage_editProcess.php?higherEducationReferenceID=$higherEducationReferenceID&pupilsightSchoolYearID=$pupilsightSchoolYearID" ?>">
