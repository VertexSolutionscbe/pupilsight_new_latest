...
if (isActionAccessible($guid, $connection2, '/modules/Higher Education/staff_manage_edit.php') == false) {
    ...
    if ($higherEducationStaffID == 'Y') {
        ...
        try {
            ...
            $sql = "SELECT higherEducationStaffID, higherEducationStaff.role, surname, preferredName FROM higherEducationStaff JOIN pupilsightPerson ON (higherEducationStaff.pupilsightPersonID=pupilsightPerson.pupilsightPersonID) WHERE status='Full' AND higherEducationStaffID=:higherEducationStaffID";
