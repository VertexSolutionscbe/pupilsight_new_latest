...
if ($higherEducationReferenceID == '' or $pupilsightSchoolYearID == '') { echo 'Fatal error loading this page!';
    ...
    $URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address'])."/references_manage_edit_contribution_delete.php&higherEducationReferenceID=$higherEducationReferenceID&higherEducationReferenceComponentID=$higherEducationReferenceComponentID&pupilsightSchoolYearID=$pupilsightSchoolYearID";
    $URLDelete = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.getModuleName($_POST['address'])."/references_manage_edit.php&higherEducationReferenceID=$higherEducationReferenceID&higherEducationReferenceComponentID=$higherEducationReferenceComponentID&pupilsightSchoolYearID=$pupilsightSchoolYearID";
