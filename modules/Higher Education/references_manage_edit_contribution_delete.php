...
if (isActionAccessible($guid, $connection2, '/modules/Higher Education/references_manage_edit.php') == false) {
    ...
    if ($higherEducationReferenceComponentID == '' or $higherEducationReferenceID == '' or $pupilsightSchoolYearID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $page->breadcrumbs->add(__('Manage References'), 'references_manage.php', ['pupilsightSchoolYearID' => $pupilsightSchoolYearID]);
            ...
            $form = DeleteForm::createForm($_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/references_manage_edit_contribution_deleteProcess.php?higherEducationReferenceComponentID=$higherEducationReferenceComponentID&higherEducationReferenceID=$higherEducationReferenceID&pupilsightSchoolYearID=$pupilsightSchoolYearID");
            echo $form->getOutput();
        }
    }
}
