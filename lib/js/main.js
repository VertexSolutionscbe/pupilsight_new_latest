(function ($) {
    ...
    $(document).on('click', '#addTransportStops', function () {
        ...
        var ncid = parseInt(cid) + 1;
        $(this).attr('data-cid', ncid);
        var design = ' <tr id="seatdiv" class=" flex flex-col sm:flex-row justify-between content-center p-0 deltr' + ncid + '"><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes " ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="stop_no" name="stop_no[' + ncid + ']" class="w-full txtfield"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes " ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="stop_name" name="stop_name[' + ncid + ']" class="w-full txtfield"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes " ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="pickup_time" name="pickup_time[' + ncid + ']" class="w-full txtfield"></div></div></div></td><td class="w-full max-w-full sm:max-w-xs flex justify-end px-2 border-b-0 sm:border-b border-t-0 newdes  " ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="drop_time" name="drop_time[' + ncid + ']" class="w-full txtfield kountseat szewdt"></div></div><div class="dte mb-1"  style="font-size: 22px; margin: 6px 0 0px 4px;"><i style="cursor:pointer" class="far fa-times-circle delSeattr" data-id="' + ncid + '"></i></div></div></td></tr>';
    ...
    $(document).on('click', '#addState', function () {
        ...
        var ncid = parseInt(cid) + 1;
        $(this).attr('data-cid', ncid);
        var design = '<tr id="seatdiv" class=" flex flex-col sm:flex-row justify-between content-center p-0 deltr' + ncid + '""><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes" ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="number" placeholder="Order" id="code" name="serialorder[' + ncid + ']" class="w-full txtfield"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes" ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="name" placeholder="State Name"  name="statename[' + ncid + ']" class="w-full txtfield" value=""></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes" ><div class="input-group stylish-input-group"><div class=" mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="code" placeholder="Code"  name="statecode[' + ncid + ']" class="w-full txtfield"></div></div></div></td><td class="w-full max-w-full sm:max-w-xs flex justify-end px-2 border-b-0 sm:border-b border-t-0 newdes sel_width" colspan="2"><div class="input-group stylish-input-group"><div class=" mb-1 ncls"></div><div class=" txtfield kountseat mb-1"><div class="flex-1 relative"><select id="notification" name="notification[' + ncid + ']" class="w-full txtfield kountseat szewdt showTemplate" data-sid="' + ncid + '"><option value >Select Notification</option><option value="1" >Email</option><option value="2" >SMS</option><option value="3" >Both</option></select></div></div><div class=" mb-1"><a href="fullscreen.php?q=/modules/Campaign/email_sms_template.php&wsid=' + ncid + '&type=" data-hrf="fullscreen.php?q=/modules/Campaign/email_sms_template.php&wsid=' + ncid + '&type=" class="thickbox" id="clickTemplate' + ncid + '" style="display:none;">click</a><input type="hidden" name="pupilsightTemplateIDs[' + ncid + ']" id="pupilsightTemplateID-' + ncid + '" value=""></div><div class="dte mb-1"  style="font-size: 25px; padding:  0 0 0px 4px"><i style="cursor:pointer" class="far fa-times-circle delSeattr" data-id="' + ncid + '"></i></div></div></td></tr><script type="text/javascript">var tb_pathToImage="lib/thickbox/loadingAnimation.gif";</script><script type="text/javascript" src="lib/thickbox/thickbox-compressed.js?v=18.0.01"></script><script type="text/javascript" src="lib/tinymce/tinymce.min.js?v=18.0.01"></script><script type="text/javascript">window.Pupilsight = {"config":{"datepicker":{"locale":"en-GB"},"thickbox":{"pathToImage":"http:\/\/localhost\/pupilsight\/lib\/thickbox\/loadingAnimation.gif"},"tinymce":{"valid_elements":"br[style],strong[style],em[style],span[style],p[style],address[style],pre[style],h1[style],h2[style],h3[style],h4[style],h5[style],h6[style],table[style],thead[style],tbody[style],tfoot[style],tr[style],td[style|colspan|rowspan],ol[style],ul[style],li[style],blockquote[style],a[style|target|href],img[style|class|src|width|height],video[style],source[style],hr[style],iframe[style|width|height|src|frameborder|allowfullscreen],embed[style],div[style],sup[style],sub[style]"},"sessionTimeout":{"sessionDuration":6400,"message":"Your session is about to expire: you will be logged out shortly."}}};</script>';
        $("#lastseatdiv").before(design);
    ...
    //   var ncid = parseInt(cid) + 1;
    //   $(this).attr('data-cid', ncid); 
    //   var design = '<tr id="" class=" flex flex-col sm:flex-row justify-between content-center p-0"><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes" ><div class="input-group stylish-input-group"><div class=" mb-1"><label for="name" class="inline-block mt-4 sm:my-1 sm:max-w-xs font-bold text-sm sm:text-xs">Name </label></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" id="name" name="seatname['+ncid+']" class="w-full txtfield"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes" ><div class="input-group stylish-input-group"><div class=" mb-1"><label for="seat" class="inline-block mt-4 sm:my-1 sm:max-w-xs font-bold text-sm sm:text-xs">Seat</label></div><div class=" txtfield mb-1" style="display:inline-flex;"><div class="flex-1 relative"><input type="number" id="seat" name="seatallocation['+ncid+']" class="w-full txtfield kountseat"></div><div class="" style="font-size: 25px; padding: 0px 0 0 25px;"><i style="cursor:pointer" class="far fa-times-circle delSeattr"></i></div></div></div></td></tr>';
    ...
    $(document).on('click', '#addFixedMultipleFineRule', function () {
        ...
        var ncid = parseInt(cid) + 1;
        $(this).attr('data-cid', ncid);
        var design = '<tr id="seatdiv" class="remdiv seatdiv flex flex-col sm:flex-row justify-between content-center p-0 deltr' + ncid + '"><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group" ><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" data-aid="' + ncid + '" id="from_date' + ncid + '" name="from_date[' + ncid + ']" class="chkfrmdate fdate w-full txtfield" autocomplete="off" maxlength="10"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group"><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" data-aid="' + ncid + '" id="to_date' + ncid + '" name="to_date[' + ncid + ']" class="chktodate tdate w-full txtfield" autocomplete="off" maxlength="10"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group"><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><select id="fixed_rule_item_type" name="fixed_rule_item_type[' + ncid + ']" class="w-full txtfield"><option value="Fixed">Fixed</option><option value="Percentage">Percentage</option></select></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group" style="display:inline-flex;"><div class="dte mb-1"></div><div class=" txtfield kountseat szewdt mb-1"><div class="flex-1 relative"><input type="text" id="fixed_rule_amt_per" name="fixed_rule_amt_per[' + ncid + ']" class="chkamnt w-full txtfield kountseat szewdt numfield"></div></div><div class="dte mb-1"  style="font-size: 25px; padding:  0px 0 0px 4px; width: 30px"><i style="cursor:pointer" class="far fa-times-circle delSeattr" data-id="' + ncid + '"></i></div></div></td></tr>';
    ...
    $(document).on('click', '#addDaySlabFineRule', function () {
        ...
        var ncid = parseInt(cid) + 1;
        $(this).attr('data-cid', ncid);
        var design = '<tr id="seatdiv2" class="remdiv seatdiv flex flex-col sm:flex-row justify-between content-center p-0 deltr' + ncid + '"><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group" ><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" data-aid="' + ncid + '" id="from_day' + ncid + '" name="from_day[' + ncid + ']" class="chkfrmday w-full txtfield numfield" autocomplete="off" maxlength="10"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group"><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><input type="text" data-aid="' + ncid + '" id="to_day' + ncid + '" name="to_day[' + ncid + ']" class="chktoday w-full txtfield numfield" autocomplete="off" maxlength="10"></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group"><div class="dte mb-1"></div><div class=" txtfield mb-1"><div class="flex-1 relative"><select id="day_slab_item_type" name="day_slab_item_type[' + ncid + ']" class="w-full txtfield"><option value="Fixed">Fixed</option><option value="Percentage">Percentage</option></select></div></div></div></td><td class="w-full  px-2 border-b-0 sm:border-b border-t-0 newdes nobrdbtm1"><div class="input-group stylish-input-group" style="display:inline-flex;"><div class="dte mb-1"></div><div class=" txtfield kountseat szewdt mb-1"><div class="flex-1 relative"><input type="text" id="day_slab_amt_per" name="day_slab_amt_per[' + ncid + ']" class="chkdayamnt w-full txtfield kountseat szewdt numfield"></div></div><div class="dte mb-1"  style="font-size: 25px; padding:  0px 0 0px 4px; width: 30px"><i style="cursor:pointer" class="far fa-times-circle delSeattr" data-id="' + ncid + '"></i></div></div></td></tr>';
        $("#lastseatdiv").before(design);
