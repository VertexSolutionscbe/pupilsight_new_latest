...
$pupilsightRoleID = $I->grabEditIDFromURL();

// Edit ------------------------------------------------
$I->amOnModulePage('User Admin', 'role_manage_edit.php', array('pupilsightRoleID' => $pupilsightRoleID));
...
// Delete ------------------------------------------------
$I->amOnModulePage('User Admin', 'role_manage_delete.php', array('pupilsightRoleID' => $pupilsightRoleID));
