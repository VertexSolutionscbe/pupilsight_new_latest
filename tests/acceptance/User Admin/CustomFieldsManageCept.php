...
$pupilsightPersonFieldID = $I->grabEditIDFromURL();

// Edit ------------------------------------------------
$I->amOnModulePage('User Admin', 'userFields_edit.php', array('pupilsightPersonFieldID' => $pupilsightPersonFieldID));
...
// Delete ------------------------------------------------
$I->amOnModulePage('User Admin', 'userFields_delete.php', array('pupilsightPersonFieldID' => $pupilsightPersonFieldID));
