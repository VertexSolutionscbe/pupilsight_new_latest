...
// Drop-downs
$I->selectOption('pupilsightRoleIDPrimary', 'Student');
$I->selectFromDropdown('pupilsightSchoolYearIDClassOf', 2);
$I->selectFromDropdown('pupilsightHouseID', 2);
...
$pupilsightPersonID = $I->grabEditIDFromURL();

// Edit ------------------------------------------------
$I->amOnModulePage('User Admin', 'user_manage_edit.php', array('pupilsightPersonID' => $pupilsightPersonID, 'search' => ''));
...
$formValues = array(
    ...
    'email'                     => 'testmctesting@pupilsight.test',
    'emailAlternate'            => 'testmctest2ing@pupilsight.test',
    ...
    'phone3CountryCode'         => '',
    'phone3Type'                => 'Fax',
    'website'                   => 'http://testing.pupilsight.test',
    'dayType'                   => 'Day Type 2',
...
// Delete ------------------------------------------------
$I->amOnModulePage('User Admin', 'user_manage_delete.php', array('pupilsightPersonID' => $pupilsightPersonID, 'search' => ''));
