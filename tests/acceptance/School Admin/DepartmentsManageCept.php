...
$pupilsightDepartmentID = $I->grabEditIDFromURL();

// Edit ------------------------------------------------
$I->amOnModulePage('School Admin', 'department_manage_edit.php', array('pupilsightDepartmentID' => $pupilsightDepartmentID));
...
// Delete ------------------------------------------------
$I->amOnModulePage('School Admin', 'department_manage_delete.php', array('pupilsightDepartmentID' => $pupilsightDepartmentID));
