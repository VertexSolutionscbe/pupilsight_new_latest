...
$pupilsightStringID = $I->grabEditIDFromURL();

// Edit ------------------------------------------------
$I->amOnModulePage('System Admin', 'stringReplacement_manage_edit.php', array('pupilsightStringID' => $pupilsightStringID));
...
// Delete ------------------------------------------------
$I->amOnModulePage('System Admin', 'stringReplacement_manage_delete.php', array('pupilsightStringID' => $pupilsightStringID));
