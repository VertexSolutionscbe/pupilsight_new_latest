...
$formValues = array(
    ...
    'pupilsightFamily'                => 'FALSE',
);

// Maually select some items (relative values)
$I->selectFromDropdown('pupilsightSchoolYearIDEntry', 2);
$I->selectFromDropdown('pupilsightYearGroupIDEntry', 2);
...
$pupilsightApplicationFormID = $I->grabTextFrom('.success b u');
$pupilsightSchoolYearID = $I->grabFromDatabase('pupilsightApplicationForm', 'pupilsightSchoolYearIDEntry', array('pupilsightApplicationFormID' => $pupilsightApplicationFormID));

// Verify ------------------------------------------------
$I->loginAsAdmin();
$urlParams = array('pupilsightApplicationFormID' => $pupilsightApplicationFormID, 'pupilsightSchoolYearID' => $pupilsightSchoolYearID);
...
$file0path = $I->grabFromDatabase('pupilsightApplicationFormFile', 'path', ['pupilsightApplicationFormID' => $pupilsightApplicationFormID, 'name' => 'FileUpload0']);
$file1path = $I->grabFromDatabase('pupilsightApplicationFormFile', 'path', ['pupilsightApplicationFormID' => $pupilsightApplicationFormID, 'name' => 'FileUpload1']);
...
$I->deleteFromDatabase('pupilsightApplicationFormFile', ['pupilsightApplicationFormID' => $pupilsightApplicationFormID]);
