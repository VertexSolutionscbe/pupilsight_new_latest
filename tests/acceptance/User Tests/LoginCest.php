...
class LoginCest
{
    ...
    public function loginTest(AcceptanceTester $I)
    {
        ...
        $I->dontSee('Login');
        $lastTimestamp = $I->grabFromDatabase('pupilsightPerson', 'lastTimestamp', ['username' => 'testingsupport']);
        $I->seeInDatabase('pupilsightLog', ['title' => 'Login - Success', 'serialisedArray LIKE' => '%testingsupport%', 'timestamp >=' => $lastTimestamp]);
    }
    ...
    public function badPassword(AcceptanceTester $I)
    {
        ...
        $lastFailTimestamp = $I->grabFromDatabase('pupilsightPerson', 'lastFailTimestamp', ['username' => 'testingsupport']);
        $lastTimestamp = $I->grabFromDatabase('pupilsightPerson', 'lastTimestamp', ['username' => 'testingsupport']);
        $failCount = $I->grabFromDatabase('pupilsightPerson', 'failCount', ['username' => 'testingsupport']);
        ...
        $I->seeInDatabase('pupilsightLog', ['title' => 'Login - Failed', 'serialisedArray LIKE' => '%testingsupport%', 'timestamp >=' => $lastTimestamp]);
    }
    ...
    public function badUser(AcceptanceTester $I)
    {
        ...
        $I->see('Incorrect username and password.', '.error');
        $I->dontSee('Logout', 'a');
        $I->seeInDatabase('pupilsightLog',  ['title' => 'Login - Failed', 'serialisedArray like' => '%'.$username.'%']);
    }
